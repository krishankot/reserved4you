...
class CosmeticsCategoryController extends Controller
{
    ...
    {
        $data = ['' => 'Kategorie auswählen '] + Category::where('category_type', 'Cosmetics')->where('status', 'active')->pluck('name', 'id')->all();
    ...
    public function edit($id)
    {
        ...
        $category = ['' => 'Kategorie auswählen '] +Category::where('category_type', 'Cosmetics')->where('status', 'active')->pluck('name', 'id')->all();
