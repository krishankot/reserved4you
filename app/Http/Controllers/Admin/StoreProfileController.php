...
class StoreProfileController extends Controller
{
    ...
    {
        $user = [''=>'Dienstleister auswählen '] + User::leftjoin('role_user', 'role_user.user_id', '=', 'users.id')
        ...
        return view('Admin.Store.create', compact('user', 'category','plan','features'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'store_profile'=>'mimes:jpeg,png,jpg',
            'store_banner'=>'mimes:jpeg,png,jpg',
            'store_gallery.*'=>'mimes:jpeg,png,jpg',
        ]);
        $data = $request->all();
             ...
             */
             ...
             if(!empty($specifics)){
                foreach($specifics as $row){
                    $specificsData['store_id'] = $store->id;
    ...
    public function edit($id)
    {
        ...
        $selectedSpecifics = StoreFeatures::where('store_id',$id)->pluck('feature_id')->all();
        ...
        return view('Admin.Store.edit', compact('user', 'category', 'data', 'selectedCategory', 'timing', 'gallery','plan','selectedSpecifics','features'));
    }
...
//            'cancellation_day' => 'required',
        ...
        $data = $request->except('_token', '_method', 'category', 'day', 'start_time', 'end_time', 'is_holiday', 'store_gallery','features');
        ...
        if ($update) {
            ...
            $deleteSpecifics = StoreFeatures::where('store_id', $id)->delete();

            if(!empty($specifics)){
               foreach($specifics as $row){
                   $specificsData['store_id'] = $id;
                   $specificsData['feature_id'] = $row;
