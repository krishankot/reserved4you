    ...
    public function authentication(Request $request)
    {
        ...
        if (!empty($user)) {
            ...
            if (Hash::check($request['password'], $user->password)) {
                ...
                return response()->json(['ResponseCode' => 0, 'ResponseText' => 'Ungültiges Passwort', 'ResponseData' => null], 400);
            }

        } else {
            return response()->json(['ResponseCode' => 0, 'ResponseText' => 'E-Mail noch nicht registriert', 'ResponseData' => null], 400);
        }
