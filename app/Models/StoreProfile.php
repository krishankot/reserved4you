...
class StoreProfile extends Model
{
    ...
    protected $fillable = ['user_id', 'store_name', 'store_start_time', 'store_end_time', 'store_contact_number',
        ...
        'store_address', 'payment_method', 'cancellation_deadline', 'appointment_contingent', 'zipcode', 'cancellation_day', 'category_id','is_value','slug','latitude','longitude','is_recommended','store_active_actual_plan','store_active_plan','is_discount'];
    ...
    {
        return $this->hasMany('App\Models\StoreEmp', 'store_id','id')->select('id','store_id','emp_name','status','image');
    ...
    {
        return $this->hasMany('App\Models\StoreFeatures', 'store_id','id');
    }
    ...
    public function storeSpecifics()
    {
        return $this->hasMany('App\Models\StoreFeatures', 'store_id','id');
    }
}
