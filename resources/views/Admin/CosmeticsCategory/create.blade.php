...
@section('content')
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{URL::to('master-admin/category')}}">Kosmetik Kategorien</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Kosmetik Kategorie erstellen </li>
                </ol>
            </nav>
            <h4 class="mb-1 mt-0">Kosmetik Kategorie erstellen </h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Kosmetik Kategorie erstellen </h4>

                    <hr/>

                    {{Form::open(array('url'=>'master-admin/cosmetics-category','method'=>'post','name'=>'create-cosmetics-category','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                <label for="validationCustom01">Hauptkategorie</label>
                    ...
                    <a href="{{URL::to('master-admin/cosmetics-category')}}" class="btn btn-danger" > Abbrechen</a>
                    {{Form::close()}}
