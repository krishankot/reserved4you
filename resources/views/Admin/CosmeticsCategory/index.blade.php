    ...
    <div class="row page-title">
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right">
                <a href="{{URL::to('master-admin/cosmetics-category/create')}}" class="btn btn-primary text-white">+Kosmetik Kategorie erstellen</a>
            </nav>
            <h4 class="mb-1 mt-1">Kosmetik Kategorien</h4>
        </div>
    </div>
