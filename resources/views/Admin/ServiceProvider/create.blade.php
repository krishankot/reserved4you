...
@section('content')
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{URL::to('master-admin/service-provider')}}">Dienstleister</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Dienstleister erstellen</li>
                </ol>
            </nav>
            <h4 class="mb-1 mt-0">Dienstleister erstellen</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Dienstleister erstellen</h4>

                    <hr/>

                    {{Form::open(array('url'=>'master-admin/service-provider','method'=>'post','name'=>'create-service-provider','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                <label for="validationCustom01">Telefonnummer</label>
                                {{Form::text('phone_number','',array('class'=>'form-control','id'=>'validationCustom01','placeholder'=>'Telefonnummer','required'))}}
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                {{Form::password('password',array('class'=>'form-control','id'=>'validationCustom04','placeholder'=>'passwort','required'))}}
                    ...
                    <a href="{{URL::to('master-admin/service-provider')}}" class="btn btn-danger" >Abbrechen</a>
                    {{Form::close()}}
