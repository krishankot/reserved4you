        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{Form::open(array('url'=>'master-admin/store-profile/'.$store_id.'/parking/'.$data['id'],'method'=>'put','name'=>'edit-parking','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <a href="{{URL::to('master-admin/store-profile/'.$store_id.'/parking')}}" class="btn btn-danger"> Abbrechen</a>
                    {{Form::close()}}
