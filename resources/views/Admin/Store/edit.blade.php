...
@section('content')
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Betriebsprofil</li>
                </ol>
            </nav>
            <h4 class="mb-1 mt-0">Edit Betriebsprofil</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Edit Betriebsprofil</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::text('store_name',$data['store_name'],array('class'=>'form-control','id'=>'validationCustom01','placeholder'=>'Name des Betriebs','required'))}}
                                @error('store_name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::text('store_contact_number',$data['store_contact_number'],array('class'=>'form-control','id'=>'validationCustom03','placeholder'=>'Telefonnummer des Betriebs'))}}
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::select('category_id',array(''=>'Kategorie auswählen ','Gastronomy'=>'Gastronomy','Cosmetics'=>"Cosmetics"),$data['category_id'],array('class'=>'form-control category','id'=>'validationCustom01','required','data-plugin'=>"customselect"))}}
                                @error('category_id')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 ">
                            <div class="form-group mb-3">
                                ...
                                {{Form::select('is_recommended',array('no'=>" Nein 	",'yes'=>"Yes"),$data['is_recommended'],array('class'=>'form-control','id'=>'validationCustom01'))}}
                         ...
                         <div class="col-lg-4 dbusiness">
                            <div class="form-group mb-3">
                                ...
                                {{Form::select('is_discount',array('no'=>" Nein ",'yes'=>"Yes"),$data['is_discount'],array('class'=>'form-control','id'=>'validationCustom01'))}}
                                @error('is_discount')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4 dbusiness">
                            <div class="form-group mb-3">
                                <label for="validationCustom01">Store Specifics (optional)</label>
                                <div id="output"></div>
                                {{Form::select('features[]',$features,$selectedSpecifics,array('class'=>'form-control chosen-select','id'=>'validationCustom01','multiple','data-plugin'=>"customselect"))}}
                                @error('features')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::textarea('store_address',$data['store_address'],array('class'=>'form-control','id'=>'autocomplete','placeholder'=>'Adresse, Hausnummer','required','rows'=>2))}}
                                @error('store_address')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::text('zipcode',$data['zipcode'],array('class'=>'form-control zipcodes','id'=>'validationCustom03','placeholder'=>'Postleitzahl','required'))}}
                                @error('zipcode')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::text('store_district',$data['store_district'],array('class'=>'form-control','id'=>'validationCustom03','placeholder'=>'Bezirk','required'))}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-3">
                                ...
                                {{Form::select('store_status',array(''=>'Select Status','active'=>"Aktive",'inactive'=>'Inactive','pending'=>'Pending'),$data['store_status'],array('class'=>'form-control','id'=>'validationCustom01','required'))}}
                                @error('store_status')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
