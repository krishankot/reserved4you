    ...
    <div class="row page-title">
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right">
                <a href="{{URL::to('master-admin/store-profile/create')}}" class="btn btn-primary text-white">+ Betriebsprofil erstellen</a>
            </nav>
            <h4 class="mb-1 mt-1">Betrieb Profile</h4>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
                        ...
                        <tr>
                            <th>ID</th>
                            <th>Name des Betriebbesitzers</th>
                            <th>Betrieb Name</th>
                            <th>Telefonnummer des Betriebs</th>
                            <th>Bezirk des Betriebs</th>
                            <th>Betrieb Kategorien</th>
                            <th>Betrieb Profile</th>
                            <th>Betrieb Banner</th>
                            <th>Betrieb Subsciption</th>
                            <th>Status</th>
                            <th>Aktion</th>
                        </tr>
                        </thead>
