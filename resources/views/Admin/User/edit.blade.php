...
@section('content')
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{URL::to('master-admin/user')}}">Benutzer</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Benutzer</li>
                </ol>
            </nav>
            <h4 class="mb-1 mt-0">Edit Benutzer</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">	
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Edit Benutzer Form</h4>

                    <hr/>

                    {{Form::open(array('url'=>'master-admin/users/'.$data['id'],'method'=>'PUT','name'=>'edit-user','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <a href="{{URL::to('master-admin/users')}}" class="btn btn-danger" >Abbrechen</a>
                    {{Form::close()}}
