@extends('layouts.front', ['setDescription'=>true])
@section('front_title')
    Become Partner
@endsection

@section('meta_description')
reserved4you - die Verwaltungssoftware für Ihren Friseur- oder Kosmetiksalon. Managen Sie mit unserer Software Ihren Salonalltag in einem übersichtlichen Panel und Ihre Termine im digitalen Kalender.
@endsection
