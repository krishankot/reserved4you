        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <a href="{{URL::to('kosmetik/'.@$store['slug'])}}" class="add-checkout-booking">
                    <span>
                        <img src="{{URL::to('storage/app/public/Frontassets/images/icon/plus.svg')}}" alt=""></span> 
                        Weiteren Service hinzufügen {{@$store['store_name']}}</a>
            </div>
        </div>
        {{Form::open(array('url'=>'update-checkout-data','method'=>'post','name'=>'update_checkout_data'))}}
            ...
            <div class="paymentaccordion paymentaccordion2" data-id="{{$row['category']['id']}}">
                ...
                <div id="collapse{{$row['category']['id']}}" class="collapse show" aria-labelledby="heading{{$row['category']['id']}}"
                    ...
                    <div class="worning-message" data-id="{{$row['category']['id']}}">
                        ...
                        <a href="#" class="btn btn-choose chooseDate"  data-id="{{$row['category']['id']}}" data-store="{{$store['id']}}" data-time="{{$row['totaltime']}}" data-change="0">
                        Wählen</a>
                    </div>
