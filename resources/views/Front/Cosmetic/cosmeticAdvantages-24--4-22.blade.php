...
@section('front_content')
    ...
    <span class="adadvantages-banner-img">
        <img src="{{URL::to('storage/app/public/Frontassets/images/adadvantages-banner.png')}}" alt="">
    </span>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-5 col-xl-6">
                    <div class="adadvantages-banner-box">
                        <h6>Wow!</h6>
                        <p>Wow ! Aktuell haben wir <span> {{ \BaseFunction::getStatisticWebsite('customer') }}+ </span> aktive Nutzer*innen auf unserer Buchungsplattform!</p>
                    </div>
    ...
    <section class="padding-100">
        <div class="container">
            ...
            <span>
                <img src="{{URL::to('storage/app/public/Frontassets/images/advantages.svg')}}" alt="">
            </span>
                <h6> Vorteile</h6>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-2.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-3.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-4.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-5.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-6.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-7.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        <div class="advantages-image">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/advantages-img-8.jpg')}}" alt="">
                        </div>
                        <div class="advantages-information">
            ...
            <div class="row step-roww step-roww-1">
                <div class="col-sm-6 col-xl-7">
                    <div class="step-img step-img-1">
                        <img src="{{URL::to('storage/app/public/Frontassets/images/step-1.png')}}" alt="">
                    </div>
                </div>
            ...
            <div class="row step-roww step-roww-2">
                ...
                <div class="col-sm-6 col-xl-7 order-1 order-sm-2">
                    <div class="step-img step-img-2">
                        <img src="{{URL::to('storage/app/public/Frontassets/images/step-2.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="row step-roww step-roww-3">
                <div class="col-sm-6 col-xl-7">
                    <div class="step-img step-img-3">
                        <img src="{{URL::to('storage/app/public/Frontassets/images/step-3.png')}}" alt="">
                    </div>
                </div>
                <div class="col-sm-6 col-xl-4">
            ...
            <div class="row step-roww step-roww-4">
                ...
                <div class="col-sm-6 col-xl-7 order-1 order-sm-2">
                    <div class="step-img step-img-4">
                        <img src="{{URL::to('storage/app/public/Frontassets/images/step-4.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="row step-roww step-roww-5">
                <div class="col-sm-6 col-xl-7">
                    <div class="step-img step-img-5">
                        <img src="{{URL::to('storage/app/public/Frontassets/images/step-5.png')}}" alt="">
                    </div>
                </div>
                <div class="col-sm-6 col-xl-4">
                ...
                <div class="item">
                    <div class="testimonial-items">
                        <div class="testimonial-profile">
                            <img src="{{URL::to('storage/app/public/Frontassets/images/experts-1.jpg')}}"
                                 alt="">
                        ...
                        <span class="quote-icon"><img
                                src="{{URL::to('storage/app/public/Frontassets/images/quote.svg')}}"
                                alt=""></span>
                    </div>
                </div>
