    ...
    <div class="index-map-image">
        ...
        <div class="map-info-box">
            <div class="map-store-img">
                <img src="{{URL::to('storage/app/public/Frontassets/images/serimg1.png')}}" alt="">
            </div>
    ...
    <!-- <div id="map_info" style="display: none;">
        <div class="map-box">
            <div class="map-box-img">
                <img src="{{URL::to('storage/app/public/Frontassets/images/pocket-bg.jpg')}}" alt="">
            </div>
        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 col-md-6">
                <div class="social-media-img">
                    <img src="{{URL::to('storage/app/public/Frontassets/images/facebook.png')}}" alt="" class="social_imgs">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
