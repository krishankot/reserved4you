...
<div class="position-relative">
	<a href="javascript:void(0);"  class="notification-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		<div class="notification-area">
			 <img src="{{URL::to('storage/app/public/Serviceassets/images/icon/notification-light.svg')}}" alt="">
		...
		<div class=" row">
			...
			<div class="col-md-12" id="notification_reqajaxtest" style="max-height:350px;overflow-y:auto;">
				<div class="notification_reqajax">
					@php $notifications = \BaseFunction::getNotifications(); @endphp
					@include('Includes.Service.notificationinner', ['notifications' => $notifications])
				</div>
			</div>
			<div class="more_notifications" rel="1"></div>
			<div class="col-md-12 mt-2 text-center"><a href="{!! url('dienstleister/benachrichtigungen') !!}">See all notifications</a></div>
		</div>
	</div>								
</div>	
