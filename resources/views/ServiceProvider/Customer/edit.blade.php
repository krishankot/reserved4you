...
@section('service_content')
    <div class="main-content">
        ...
        {{Form::open(array('url'=>'service-provider/update-customer/'.encrypt($customer['id']),'method'=>'post','name'=>'add-customer','id'=>'add_customer','files'=>'true'))}}
        ...
        <div class="consumer-form">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <input type="text" placeholder="Vor-/Nachname" name="name" value="{{$customer['name']}}" class="consumer-input" required>
                </div>
                <div class="col-lg-6">
                    <input type="text" placeholder="Adresse" name="address" class="consumer-input" value="{{$customer['address']}}" id="autocomplete">
                </div>
                <div class="col-lg-6">
                    <input type="text" placeholder="E-Mail" name="email"  class="consumer-input" value="{{$customer['email']}}" required>
                </div>
                <div class="col-lg-6">
                    <input type="text" placeholder="Land" name="state" class="consumer-input" value="{{$customer['state']}}">
                </div>
                <div class="col-lg-6">
                    <input type="text" placeholder="Telefonnummer " name="phone_number" class="consumer-input" value="{{$customer['phone_number']}}" required>
                </div>
                <div class="col-lg-6">
                    <input type="text" placeholder="Postleitzahl" name="zipcode" class="consumer-input zipcodes" value="{{$customer['zipcode']}}">
                </div>
            </div>
        </div>
