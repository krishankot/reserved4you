...
@section('service_content')
    <div class="main-content">
        {{Form::open(array('url'=>'service-provider/add-employee','method'=>'post','name'=>'add-employee','id'=>'add_employee','files'=>'true','novalidate'))}}
{{--        @if ($errors->any())--}}
...
{{--        @endif--}}
        <div class="page-title-div">
            ...
            <p><a href="{{URL::to('dienstleister/mitarbeiter')}}" >Mitarbeiter </a> <span> / Profil hinzufügen </span></p>
        </div>
                        ...
                        <div class="hours-tabel-main">
                            ...
                            <div class="hours-tabel-body-wrap  @if(\Carbon\Carbon::now()->format('l') == $store_time[0]['day']) active @endif">
                                ...
                                <div class="hours-time-wrap">
                                    ...
                                    <span>Von</span>
                                    <input type="text" class="timepicker start_time" name="start_time[]" placeholder=" -- --" value="{{$store_time[0]['start_time']}}" {{$store_time[0]['is_off'] == 'on' ? 'readonly'  :''}} {{$store_time[0]['is_off'] == 'on' ? 'style=pointer-events:none !important'  :''}}
                                           data-id="Monday">
                                    <span>Bis</span>
