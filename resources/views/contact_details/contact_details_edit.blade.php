...
<body>
	...
	<section class="contactdetail">
		<div class="progress">
			<div class="progress-bar progressbarr4u" role="progressbar" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
		</div>
		<div class="container">
			<div class="contactheading">
				<h2>Kontaktdetails</h2>
			</div>
			<form action="{{url('contactdetail/update/'.$contactdetails->id)}}" method="post" name="myform" onsubmit="return validate()">
			@csrf
			<div class="filldetail">
				<div class="row">
					<div class="col-lg-4">
						<input type="text" name="storename" placeholder="Salonname" autocomplete="off" value="{{$contactdetails->storename}}" class="storname contact">
					    <sapn id="store" style="padding:10px"class="text-danger"></sapn>
					</div>
					<div class="col-lg-4">
						<input type="text" name="firstname" placeholder="Vorname" autocomplete="off" value="{{$contactdetails->firstname}}" class="fname contact">
					    <sapn id="fname" style="padding:10px"class="text-danger"></sapn>
					</div>
					<div class="col-lg-4">
						<input type="text" name="Lastname" placeholder="Nachname" autocomplete="off" value="{{$contactdetails->Lastname}}" class="lname contact">
					    <sapn id="lname" style="padding:10px"class="text-danger"></sapn>
					</div>
					<div class="col-lg-6">
						<input type="email" name="Email" placeholder="Email"  autocomplete="off" value="{{$contactdetails->Email}}" class="mail contact">
					...
					<div class="col-lg-6">
						<input type="text" name="Address" class="house_number contact"  value="{{$contactdetails->Address}}" id="txtPlaces" autocomplete="off" placeholder="Straße, Hausnummer">
						<sapn id="addr" style="padding:10px"class="text-danger"></sapn>

					</div>
					
					<div class="col-lg-6">
						<input type="text" name="Zipcode" class="house_number contact" value="{{$contactdetails->Zipcode}}" autocomplete="off" placeholder="PLZ">
			...
			<div class="letscountinuesbtn"> <button class="letscontinues" type="submit">Weiter</a>
			</div>
			</form>
		</div>
	</section>
...
function validate(){
	...
	if (Phone==null || Phone==""){
    	...
    	document.getElementById("nophone").innerHTML="Please enter min 11 digite.";
    	return false;
    }else{
	...
	if (District==null ||District ==""){
    	document.getElementById("districts").innerHTML="Please Enter District.";
    	return false;
    }else{
        document.getElementById("districts").innerHTML="";
    }
	if (Country==null ||Country ==""){
    	document.getElementById("countrys").innerHTML="Please Enter Country.";
    	return false;
    }else{
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBSItHxCbk9qBcXp1XTysVLYcJick5K8mU&libraries=places"></script>
