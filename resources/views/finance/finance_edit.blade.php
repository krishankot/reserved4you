    ...
    <div class="container">
        ...
        <form name="myform">
            ...
            <div class="paymentterms bankpaydetail">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="account_holder">
                            ...
                            <input type="text" name="Account_holder" id="accountholder"
                                   value="{{$bankdetails->Account_holder}}" class="backdetail">
                    ...
                    <div class="col-lg-12">
                        <div class="bankcode">
                            ...
                            <input type="text" name="Bank_code" id="Bankcode" value="{{$bankdetails->Bank_code}}"
                                   class="backdetail">
                    ...
                    <div class="col-lg-12">
                        <div class="iban">
                            <label>IBAN :</label>
                            <input type="text" name="Iban" id="Ibanno" value="{{$bankdetails->Iban}}"
                                   class="backdetail">
                ...
                <div class="financeviamail">
                    <label for="plans-1" class="sendmailvia">
                        <input type="radio" name="Invoice_method" id="plans-1"
                               value="Via Email" {{$bankdetails->Invoice_method == 'Via Email' ? 'checked' : ''}}>
                        <p class="viamail">Per E-Mail</p>
                    </label>
                    <label for="plans-2" class="plans-label paylbl sendmailvia">
                        <input type="radio" name="Invoice_method" id="plans-2"
                               value="By post" {{$bankdetails->Invoice_method == 'By post' ? 'checked' : ''}}>
            ...
            <div class="servicebtns  financebtn"><a href="{{url('payment')}}" class="previous" type="btn">Zurück</a>
                <a href="javascript:void(0)" class="next" type="btn" onclick="extra_service_store()">Weiter</a>
            </div>
        </form>
    </div>
</section>
...
<script>
    ...
    function extra_service_store() {
        ...
        var URL = '{{URL::to('bank/details/edit/')}}';
        var id = '{{$bankdetails->id}}';
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.status == 'true'){
                    console.log("plan Activate successfully");
