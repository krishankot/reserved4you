...
<head>
    ...
    <link type="image/x-icon" rel="shortcut icon"
          href="{{URL::to('storage/app/public/Serviceassets/images/favicon.png')}}"/>
    <!-- Required meta tags -->
    <meta charset="UTF-8"/>
    ...
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/bootstrap.min.css')}}"/>
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/jquery.fancybox.min.css')}}"/>
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/owl.carousel.min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{URL::to('storage/app/public/Serviceassets/css/nice-select.css')}}"/>
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/bootstrap-datepicker.css')}}"/>
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/dataTables.bootstrap4.min.css')}}"/>
    <link type="text/css" rel="stylesheet"
          href="{{URL::to('storage/app/public/Serviceassets/css/responsive.bootstrap4.min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{URL::to('storage/app/public/Serviceassets/css/select2.min.css')}}" />
    <link type="text/css" rel="stylesheet" href="{{URL::to('storage/app/public/Serviceassets/css/timepicker.css')}}" />
	<link type="text/css" rel="stylesheet" href="{{asset('storage/app/public/asset_request/css/bootstrap-datetimepicker.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{URL::to('storage/app/public/Serviceassets/css/style2.css')}}"/>
    ...
    <link type="text/css" rel="stylesheet" href="{{URL::to('storage/app/public/Serviceassets/css/responsive2.css')}}"/>
...
<script src="{{URL::to('storage/app/public/Serviceassets/js/jquery.fancybox.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/owl.carousel.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/jquery.nice-select.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/bootstrap-datepicker.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/jquery.dataTables.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/dataTables.bootstrap4.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/dataTables.responsive.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/responsive.bootstrap4.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/select2.min.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/timepicker.js')}}"></script>
<script src="{{URL::to('storage/app/public/Serviceassets/js/Chart.js')}}"></script>
{{--<script src="{{URL::to('storage/app/public/Serviceassets/js/mychart.js')}}"></script>--}}
<script src="https://momentjs.com/downloads/moment-with-locales.js"></script>
<script src="{{asset('storage/app/public/asset_request/js/moment.js')}}"></script>
<script src="{{asset('storage/app/public/asset_request/js/bootstrap-datetimepicker.min.js')}}"></script>
  ...
  $("#menu-button").click(function(){
	...
	function updateNotifications(){
		//page = $('.more_notifications').attr('rel');
		 ...
		 $.ajax({
			...
			url: "{{URL::to('service-provider/notification_count')}}",
			success: function (response) {
	...
	$('.dropdown-menu').on('mouseenter', function(event){
		if($(this).hasClass('header_notification')) {
			$.ajax({
				url: "{{ url('service-provider/ajaxnotificationsread') }}",
				method: 'GET',
				dataType: 'json',
