					...
					<div class="paymenttermsinfo">
						<div class="paymentterm-wrap">
							<ul class="nav nav-pills payment-nav" id="pills-tab" role="tablist">
								...
								<a class="nav-link paymentterm active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"> Sepa Lastschrift Mandat (empfohlen) </a>
								</li>
								<li class="nav-item" role="presentation" onclick="Payment_terms='Invoice Method';">
								<a class="nav-link peymentterm" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Invoice Methode</a>
								</li>
							</ul>
						</div>
					</div>
        ...
        function plan_paytm(){
            $.ajax({
                ...
                success: function(data) {
                	...
                	window.location.replace("{{ URL::to('finance') }}");
                    console.log("paytm successfully");
                }
            });
        }
	</script>
