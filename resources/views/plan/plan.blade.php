...
<body>
	...
	<section class="contactdetail">
		<div class="progress">
			<div class="progress-bar progressbarr4u" role="progressbar" style="width: 20%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
		</div>
		<div class="container">
			...
			<div class="nextprevious servicebtns letscountinuesbtn nextprevious"> <a href="{{url('contactdetail')}}" class="previous" type="btn">Zurück</a>
	...
	<script>
		...
		// $('.plans-label').click(function (e) { 
		// 	$('.plans-label').removeClass('text-change');
		...
		// 		// $('.selectbtntext').text("new dialog title");
		// 		$(this).find(".selectbtntext").text("new text");
		// 	} else {
		// 		$(this).find(".selectbtntext").text("old text");
		// 	}
		// });
