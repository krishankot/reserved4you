...
<section class="contactdetail  extraservicesection">
    ...
    <div class="container">
        ...
        <div class="servicetype">
            <div class="service-type-wrap">
                <ul class="nav nav-pills service-nav" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation3" onclick="Service_name='Marketing';">
            ...
            <div class="tab-pane fade show active feature" id="pills-home" role="tabpanel"
                ...
                <div class="container  chooseplan1">
                    <div class="owl-carousel owl-theme chooseservices">
                        <div class="item payadvance">
                            ...
                            <div class="monthly_annually_plans">
                                <div class="monthly_annually_plans-wrap">
                                                ...
                                                <div class="monthpriceplan">
                                                    ...
                                                    <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                        <li class="nav-item" role="presentation"
                                                            ...
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Monthly' ? 'active' : ''}}"
                                                               id="pills-home-tab"
                                                               data-toggle="pill" href="#pills-home-01" role="tab"
                                                               data-id="f1"
                                                               data-name="Monthly"
                                                               aria-controls="pills-home"
                                                               aria-selected="true">Monatlich</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation"
                                                            onclick="feature_plan_type='Annually';">
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Annually' ? 'active' : ''}}"
                                                               id="pills-pay-tab"
                                                               data-toggle="pill" href="#pills-pay-01" role="tab"
                                                               data-id="f1"
                                                               data-name="Annually"
                                                    ...
                                                    <div class="payimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/pay.svg')}}">
                                                        <p>Ihre Kunden haben die Möglichkeit ihre gebuchten Services
                                                            ...
                                                            etc.), dennoch besteht auch die Möglichkeit vor Ort zu
                                                            zahlen.</p>
                                                    </div>
                                                    <div class="selectitbtn" onc>
                                                        <p class="selectbtntext">Auswählen</p>
                                                    </div>
                                                </div>
                                            </label>
                                    ...
                                    @if($i == 0)
                                        <label for="plans-1" class="plans-label paylbl">
                                            <input type="checkbox" name="featur_plans" id="plans-1"
                                                   class="features"
                                                   data-id="f1"
                                                   data-name="Onlinezahlungen" data-amount="2.5%"
                                                   data-plan="Monthly">
                                            <div class="monthpriceplan">
                                                <div class="monthprice">
                                                    <h2>2.5% <span>/Per Onlinezahlung</span></h2>
                                                ...
                                                <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                    <li class="nav-item" role="presentation"
                                                        onclick="feature_plan_type='Monthly';">
                                                        <a class="nav-link monthlyplan active"
                                                           id="pills-home-tab"
                                                           data-toggle="pill" href="#pills-home-01" role="tab"
                                                           data-id="f1"
                                                           data-name="Monthly"
                                                    ...
                                                    <li class="nav-item" role="presentation"
                                                        ...
                                                        <a class="nav-link monthlyplan" id="pills-pay-tab"
                                                           ...
                                                           aria-selected="false">Jährlich</a>
                                                    </li>
                                                </ul>
                                                <div class="payimg">
                        ...
                        <div class="item payadvance">
                            <div class="monthly_annually_plans">
                                <div class="monthly_annually_plans-wrap">
                                    <div style="display: none">{{$i= 0}}</div>
                                    @foreach($extraservice as $row)
                                        @if($row->Service_plan == 'Rabatte für Kunden')
                                            <label for="plans-2" class="plans-label paylbl">
                                                <input type="checkbox" name="featur_plans" id="plans-2" class="features"
                                                       data-id="f2"
                                                       data-name="Rabatte für Kunden" data-amount="{{$row->plan_type == 'Monthly' ? '15.00' : '7.50'}}" checked
                                                       data-plan="{{$row->plan_type == 'Monthly' ? 'Monthly' : 'Annually'}}">
                                                <div class="monthpriceplan">
                                                    <div class="monthprice">
                                                        <h2><label class="monthprice_value"
                                                                   data-id="f2">{{$row->plan_type == 'Monthly' ? '15.00' : '7.50'}}€</label><span>/ Monat</span></h2>
                                                    </div>
                                                    ...
                                                    <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Monthly' ? 'active' : ''}}"
                                                               id="pills-home-tab"
                                                               data-toggle="pill" href="#pills-home-02" role="tab"
                                                               data-id="f2"
                                                               data-name="Monthly"
                                                               aria-controls="pills-home" data-value="15.00"
                                                               aria-selected="true">Monatlich</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Annually' ? 'active' : ''}}"
                                                               id="pills-pay-tab"
                                                               data-toggle="pill" href="#pills-pay-02" role="tab"
                                                               data-id="f2"
                                                    ...
                                                    <div class="payimg disimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/disccount.svg')}}">
                                    ...
                                    @if($i == 0)
                                        <label for="plans-2" class="plans-label paylbl">
                                            <input type="checkbox" name="featur_plans" id="plans-2"
                                                   class="features"
                                                   data-id="f2"
                                                   data-name="Rabatte für Kunden" data-amount="15"
                                                   data-plan="Monthly">
                                            <div class="monthpriceplan">
                                                <div class="monthprice">
                                                    <h2><label class="monthprice_value"
                                                               data-id="f2">15.00€</label><span>/ Monat</span></h2>
                                                </div>
                                                <h3 class="advance">Rabatt für Kunden</h3>
                                                <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link monthlyplan active"
                                                           id="pills-home-tab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link monthlyplan" id="pills-pay-tab"
                                                           ...
                                                           data-id="f2"
                                                           data-name="Annually"
                                                           aria-controls="pills-profile" data-value="7.50"
                                                           aria-selected="false">Jährlich</a>
                                                    </li>
                                                </ul>
                                                <div class="payimg disimg">
                        ...
                        <div class="item payadvance">
                            <div class="monthly_annually_plans">
                                <div class="monthly_annually_plans-wrap">
                                    <div style="display: none">{{$i= 0}}</div>
                                    @foreach($extraservice as $row)
                                        @if($row->Service_plan == 'Empfehlungslisten')
                                            <div style="display: none">{{$i = 1}}</div>

                                            <label for="plans-3" class="plans-label paylbl">
                                                <input type="checkbox" name="featur_plans" id="plans-3" class="features"
                                                       data-id="f3"
                                                       data-name="Empfehlungslisten" data-amount="{{$row->plan_type == 'Monthly' ? '30.00' : '20.00'}}" checked
                                                       data-plan="{{$row->plan_type == 'Monthly' ? 'Monthly' : 'Annually'}}">
                                                <div class="monthpriceplan">
                                                    <div class="monthprice">
                                                        <h2><label class="monthprice_value"
                                                                   data-id="f3">{{$row->plan_type == 'Monthly' ? '30.00' : '20.00'}}€</label><span>/ Monat</span></h2>
                                                    </div>
                                                    ...
                                                    <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Monthly' ? 'active' : ''}}"
                                                               id="pills-home-tab"
                                                               data-toggle="pill" href="#pills-home-03" role="tab"
                                                               data-id="f3"
                                                        ...
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link monthlyplan {{$row->plan_type == 'Annually' ? 'active' : ''}}"
                                                               id="pills-pay-tab"
                                                               data-toggle="pill" href="#pills-pay-03" role="tab"
                                                               data-id="f3"
                                                    ...
                                                    <div class="payimg recomimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/recommandation.svg')}}">
                                                        <p>Um eine größere Reichweite zu generieren , haben Sie die
                                                            Möglichkeit in unseren
                                                            Empfehlungslisten aufgelistet zu sein. Diese findet man in
                                                            jedem Bereich auf unserer
                                                            Webseite.</p>
                                                    </div>
                                                    <div class="selectitbtn">
                                                        <p class="selectbtntext">Auswählen</p>
                                    ...
                                    @if($i == 0)
                                        <label for="plans-3" class="plans-label paylbl">
                                            <input type="checkbox" name="featur_plans" id="plans-3" class="features"
                                                   data-id="f3"
                                                   data-name="Empfehlungslisten" data-amount="30"
                                                   data-plan="Monthly">
                                            <div class="monthpriceplan">
                                                <div class="monthprice">
                                                    <h2><label class="monthprice_value"
                                                               data-id="f3">30.00€</label><span>/ Monat</span></h2>
                                                </div>
                                                <h3 class="advance">Empfehlungslisten</h3>
                                                <ul class="nav nav-pills payment" id="pills-tab" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                ...
                                                <div class="payimg recomimg">
                                                    ...
                                                    <p>Um eine größere Reichweite zu generieren , haben Sie die
                                                        Möglichkeit in unseren
                                                        Empfehlungslisten aufgelistet zu sein. Diese findet man in jedem
                                                        Bereich auf unserer
                                                        Webseite.</p>
                                                </div>
                                                <div class="selectitbtn">
                        ...
                        {{--                                    <div style="display: none">{{$i= 0}}</div>--}}
                        {{--                                    @foreach($extraservice as $row)--}}
                        {{--                                        @if($row->Service_plan == 'Pay in advance 2' && $row->Service_amount == '40')--}}
                        {{--                                            <label for="plans-4" class="plans-label paylbl">--}}
                        {{--                                                <input type="checkbox" name="featur_plans" id="plans-4" class="features"--}}
                        {{--                                                       data-id="f4"--}}
                        {{--                                                       data-name="Pay in advance 2" data-amount="40" checked--}}
                        {{--                                                       data-plan="Monthly">--}}
                        {{--                                                <div class="monthpriceplan">--}}
                        {{--                                                    <div class="monthprice">--}}
                        {{--                                                    <h2>40.00€<span>/Monat</span></h2>--}}
                        {{--                                                    </div>--}}
                        {{--                                                    <h3 class="advance">Vorauszahlung</h3>--}}
                        {{--                                                    <ul class="nav nav-pills payment" id="pills-tab" role="tablist">--}}
                        {{--                                                        <li class="nav-item" role="presentation"><a--}}
                        {{--                                                                class="nav-link monthlyplan {{$row->plan_type == 'Monthly' ? 'active' : ''}}"--}}
                        {{--                                                                id="pills-home-tab"--}}
                        ...
                        {{--                                                        </li>--}}
                        {{--                                                        <li class="nav-item" role="presentation"><a--}}
                        {{--                                                                class="nav-link monthlyplan {{$row->plan_type == 'Annually' ? 'active' : ''}}"--}}
                        {{--                                                                id="pills-pay-tab"--}}
                        {{--                                                                data-id="f4"--}}
                        {{--                                                                data-name="Annually"--}}
                        ...
                        {{--                                                        <div class="tab-pane fade show active" id="pills-home-1"--}}
                        {{--                                                             role="tabpanel"--}}
                        {{--                                                             aria-labelledby="pills-home-tab">--}}
                        {{--                                                            <div class="payimg">--}}
                        {{--                                                                <img--}}
                        ...
                        {{--                                    @if($i == 0)--}}
                        {{--                                        <label for="plans-4" class="plans-label paylbl">--}}
                        {{--                                            <input type="checkbox" name="featur_plans" id="plans-4"--}}
                        {{--                                                   class="features"--}}
                        {{--                                                   data-id="f4"--}}
                        {{--                                                   data-name="Pay in advance 2" data-amount="40"--}}
                        {{--                                                   data-plan="Monthly">--}}
                        {{--                                            <div class="monthpriceplan">--}}
                        {{--                                                <div class="monthprice">--}}
                        {{--                                                <h2>40.00€<span>/Monat</span></h2>--}}
                        ...
                        {{--                                                <ul class="nav nav-pills payment" id="pills-tab" role="tablist">--}}
                        {{--                                                    <li class="nav-item" role="presentation"><a--}}
                        {{--                                                            class="nav-link monthlyplan active"--}}
                        {{--                                                            id="pills-home-tab"--}}
                        {{--                                                            data-id="f4" data-name="Monthly"--}}
                        {{--                                                            data-toggle="pill" href="#pills-home-1" role="tab"--}}
                        {{--                                                            aria-controls="pills-home"--}}
                        ...
                        {{--                                                    </li>--}}
                        {{--                                                    <li class="nav-item" role="presentation"><a--}}
                        {{--                                                            class="nav-link monthlyplan" id="pills-pay-tab"--}}
                        {{--                                                            data-id="f4"--}}
                        {{--                                                            data-name="Annually"--}}
                        {{--                                                            data-toggle="pill" href="#pills-pay-1" role="tab"--}}
                        {{--                                                            aria-controls="pills-profile"--}}
                                        ...
                                        <div class="monthpriceplan">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home-1" role="tabpanel"
                                                    ...
                                                    <div class="payimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/news.svg')}}">
                                        ...
                                        <div class="monthpriceplan">
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home-1" role="tabpanel"
                                                    ...
                                                    <div class="payimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/social-media.svg')}}">
                                                        <!-- <p>Lorem ipsum dolor sit amet consectetur adipiscing eiusmod
                                                            tempor</p>
                                                       -->
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="pills-pay-1" role="tabpanel"
                                                    ...
                                                    <div class="payimg">
                                                        <img
                                                            src="{{asset('public/asset_front/assets/images/dissocial-mediaccount.svg')}}">
                                                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipiscing eiusmod
                                                            tempor</p>  -->
                            ...
                            <div class="monthly_annually_plans">
                                <div class="monthly_annually_plans-wrap">
                                    ...
                                    @foreach($hardware as $row)
                                        @if($row->Service_plan == 'APPLE iPad')
                                            <div style="display: none">{{$i = 1}}</div>

                                            <label for="plans-09" class="plans-label paylbl">
                                                <input type="checkbox" name="hardware_plans" id="plans-09"
                                                       class="features"
                                                       data-id="f9" checked
        ...
        <div class="letscountinuesbtn nextprevious servicebtns"><a href="{{url('recom-plan')}}" class="previous"
            ...
            <a href="" class="next submittonext" type="btn">Weiter</a>
        </div>
    </div>
</section>
...
<script>
    ...
    $(document).on('click', '.submittonext', function () {
        var Service_plan = [];
        var plan_type = [];
        var Service_amount = [];
        ...
        var URL = '{{URL::to('services/update')}}';
        var id = '{{$id}}';
