...
<div class="position-relative">
	...
	<div class="dropdown-menu dropdown-menu-right position-absolute header_notification" style="max-width:425px;padding:15px;border-radius:10px;background:#F9F9FB;border:1px solid #E8E8EC;">
		<div class=" row">
			...
			<div class="col-md-12 mt-2 text-center"><a href="<?php echo url('service-provider/notification'); ?>">See all notifications</a></div>
		</div>
	</div>								
</div>	
...
</div><?php /**PATH /var/www/html/resources/views/Includes/Service/notificationpopup.blade.php ENDPATH**/ ?>