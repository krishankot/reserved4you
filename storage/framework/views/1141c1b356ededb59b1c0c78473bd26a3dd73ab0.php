...
<?php $__env->startSection('service_content'); ?>
    <div class="main-content">
        ...
        <div class="appointment-header customers-header mb-3">
            ...
            <a href="<?php echo e(URL::to('dienstleister/mitarbeiter-hinzufuegen')); ?>" class="employeebtn appointment-btn btn-yellow">Neuen Mitarbeiter hinzufügen</a>
                ...
                <div class="col-lg-4 col-mb-6">
                    <div class="employee-item-box">
                        <div class="employee-item">
                            ...
                            <a href="<?php echo e(URL::to('dienstleister/mitarbeiter-details/'.encrypt($row->id))); ?>"
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/ServiceProvider/Employee/index.blade.php ENDPATH**/ ?>