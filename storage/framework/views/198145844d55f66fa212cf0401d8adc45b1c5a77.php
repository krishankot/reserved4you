                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $getReview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="review-info-items">
                                    <div class="review-info-header-wrap">
                                     ...
                                     <div class="setting-store-detail" onclick="window.location.href='<?php echo e(URL::to('kosmetik/'.@$row->storeDetaials->slug)); ?>'">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/User/setting.blade.php ENDPATH**/ ?>