            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-0">
						...
						<a href="<?php echo e(url('service-provider/create-appointment')); ?>" class="appointment-btn ml-auto btn-yellow">Neuen Termin hinzufügen</a>
						</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.change-store').change(function () {
                let val=$(this).val();
                window.location.href='<?php echo e(url('service-provider/calender')); ?>?id='+val;
            });
            function removeAllDay() {
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Calender/calendar.blade.php ENDPATH**/ ?>