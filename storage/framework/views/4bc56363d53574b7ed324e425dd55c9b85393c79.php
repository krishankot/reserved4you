...
<footer>
        <div class="container">
            <div class="top-footer">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-4">
                        ...
                        <ul class="footer-menu">
                            <li><a href="<?php echo e(route('kosmetic.search')); ?>">Bereiche </a></li>
                            <li><a href="<?php echo e(URL::to('kosmetik-deine-vorteile')); ?>">Deine Vorteile</a></li>
                            <li><a href="<?php echo e(URL::to('geschaeftspartner')); ?>">Für Geschäftspartner</a></li>
                        </ul>
                    </div>
					 <div class="col-xl-3 col-lg-2 col-md-4 col-4">
                        <h4>Rechtliches</h4>
                        <ul class="footer-menu">
                            <li><a href="<?php echo e(route('imprint')); ?>">Impressum </a></li>
                            <li><a href="<?php echo e(route('datenschutz')); ?>">Datenschutz</a></li>
                            <li><a href="<?php echo e(route('agb')); ?>">AGB</a></li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-4">
                        ...
                        <ul class="footer-menu">
						 ...
						 <div class="footer-btn-wrap justify-content-start mb-0">
                            <a href="javascript:void(0)"><img loading="lazy" loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/google-play.svg')); ?>" alt=""
                                    style="display :block!important"></a>
						 </div>
						  <div class="footer-btn-wrap justify-content-start mt-0">
                            <a href="javascript:void(0)"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/apple-play.svg')); ?>" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <h4>Hast du Fragen?</h4>
						 <ul class="footer-contactinfo">
							<li><a href="mailto:support@reserved4you.de"><i class="fa fa-envelope"></i>support@reserved4you.de</a>
							<p><a class="pe-none" href="javascript:void(0)">Oder du erreichst uns unter</a></p></li>
							<li><a class="pe-none" href="javascript:void(0)">Mo. - Fr.: 08:00 - 22:00 Uhr</a>
							<p><a class="pe-none" href="javascript:void(0)">Sa. - So.: 10:00 - 18:00 Uhr</a></p></li>
							<li><a class="pe-none" href="javascript:void(0)"><i class="fa fa-phone"></i>+49 30 1663969321</a></li>
							<li><a class="pe-none" href="javascript:void(0)"><i class="fa fa-comment"></i> Live Chat</a></li>
						</ul>
                        <!-- <ul class="language">
                            <li><a href="javascript:void(0)"><span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/germany.svg')); ?>"
                                            alt=""></span> DE
                                </a></li>
                            <li><a href="javascript:void(0)"><span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/usa-today.svg')); ?>"
                                            alt=""></span>EN</a> </li>
                            <li><a href="javascript:void(0)"><span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/french-guiana.svg')); ?>"
                                            alt=""></span>FR</a></li>
                        </ul>
                        <div id="google_translate_element"></div>
                        <div class="footer-btn-wrap">
                            <a href="javascript:void(0)"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/google-play.svg')); ?>" alt=""
                                    style="display :block!important"></a>
                            <a href="javascript:void(0)"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/apple-play.svg')); ?>" alt=""></a>
                        </div> -->
                    </div>
                ...
                <div class="f-logo">
                    <a href="index.php"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/f-logo.png')); ?>" alt=""></a>
                </div>
...
<?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Includes/Front/footer.blade.php ENDPATH**/ ?>