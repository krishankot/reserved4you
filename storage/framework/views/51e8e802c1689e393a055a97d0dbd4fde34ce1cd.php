            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade <?php echo e((!empty($_GET['t']) && $_GET['t'] == 'reviews')?'':'show active'); ?>" id="pills-about" role="tabpanel"
                    ...
                    <div class="button-wrap">
                        ...
                        <a href="<?php echo e(URL::to('dienstleister/betriebsprofil/ansehen/'.$data->id)); ?>"
                    ...
                    <div class="store-service">
                        <div class="store-main-service">
                            <div class="service-header-wrap">
                                <h5>Services</h5>
                                <div>
                                    <a href="<?php echo e(URL::to('dienstleister/service-hinzufuegen')); ?>" class="btn btn-black-yellow">Service hinzufügen</a>
                                </div>
                            </div>
                                        ...
                                        <div class="service-item-main" id="service_item<?php echo e($row->id); ?>">
                                            ...
                                            <div class="service-item-info">
                                                <div class="service-action-wrap">
                                                    <a href="<?php echo e(URL::to('dienstleister/service-bearbeiten/'.encrypt($row->id))); ?>"><img
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/ServiceProvider/Store/index.blade.php ENDPATH**/ ?>