                ...
                <div class="tab-pane fade show active" id="pills-new" role="tabpanel" aria-labelledby="pills-new-tab">
                    <div class="owl-carousel owl-theme" id="new-area-owl">
                        <?php $__empty_1 = true; $__currentLoopData = $new_store; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="item" onclick="window.location.href='<?php echo e(URL::to('kosmetik/'.$row['slug'])); ?>'" style="cursor: pointer;">
                        ...
                        <div class="area-item-wrap" onmouseenter="showme(<?php echo $key; ?>);">
                            <div class="area_img">
                                <div class="owl-carousel owl-theme area-img-owl" id="area-img-owl">
                                    <div class="item"
                                         onclick="window.location.href='<?php echo e(URL::to('kosmetik/'.$row['slug'])); ?>'">
                                        <div class="area-img">
                                            <img
                                                src="<?php echo e(URL::to('storage/app/public/store/'.(($row->store_profile == '')?'Store-6058bde8bf5a8.JPEG':$row->store_profile))); ?>"
                                                alt="">
                            ...
                            <div class="area_info">
                                <h6 onclick="window.location.href='<?php echo e(URL::to('kosmetik/'.$row['slug'])); ?>'"><?php echo e($row->store_name); ?></h6>
                                <p>
                                    <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/location.svg')) ?></span>
    ...
    <script type="text/javascript">
        ...
        $(".serach_btn").on('click', function () {
            ...
            $.ajax({
                type: 'POST',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                url: "<?php echo e(route('kosmetic.search')); ?>",
                beforesend: $('#loading').css('display', 'block'),
                data: data,
                success: function (response) {
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/Cosmetic/cosmeticArea.blade.php ENDPATH**/ ?>