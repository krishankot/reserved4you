...
<?php $__env->startSection('service_content'); ?>
    <div class="main-content">
        <div class="page-title-div">
            ...
            <p><a href="<?php echo e(URL::to('service-provider/customers')); ?>">Kunden</a> <span>/ Kundeninformationen </span></p>
        </div>
...
<?php $__env->startSection('service_js'); ?>
    <script>
		...
		$(document).on('click', '.postpond_app', function () {
			...
			swal({
				title: false,
				text: "Are you sure you want to move it?",
				type: "warning",
				buttons: ["Cancel!", "Yes!"],
				dangerMode: true,
			}).then((value) => {
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Customer/view.blade.php ENDPATH**/ ?>