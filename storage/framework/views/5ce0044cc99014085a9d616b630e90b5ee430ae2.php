...
<?php $__env->startSection('service_content'); ?>
    <div class="main-content">
        ...
        <div class="appointment-header">
            ...
            <a href="<?php echo e(URL::to('service-provider/create-appointment')); ?>" class="appointment-btn btn-yellow">Neuen Termin hinzufügen</a>
                                ...
                                <ul>
                                    ...
                                    <?php else: ?>
                                        <li class="review-see-wrap">
                                            ...
                                            <a href="<?php echo e(url('service-provider/store-profile?t=reviews#t'.@$row->is_reviewed->id)); ?>" class="btn see-review">Bewertung anzeigen</a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Appointment/index.blade.php ENDPATH**/ ?>