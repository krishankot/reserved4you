...
<link type="text/css" rel="stylesheet" href="<?php echo e(URL::to('storage/app/public/Frontassets/css/plans.css')); ?>"/>
<style>
        ...
        <div class="container">
            <div class="business-banner-info">
                ...
                <div class="business-banner-img">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/banner-hand.svg')); ?>" alt=""></span>
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/business-banner.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="tab-pane fade show active" id="pills-advantages" role="tabpanel"
                    ...
                    <div class="row advantages_rows">
                        <div class="col-lg-6 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-1.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                            ...
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-1.svg')); ?>"
                                     alt="">
                            </span>
                    ...
                    <div class="row advantages_rows">
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-2.svg')); ?>"
                                     alt="">
                            </span>
                        ...
                        <div class="col-lg-6 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-2.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row advantages_rows">
                        <div class="col-lg-6 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-3.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-3.svg')); ?>"
                                     alt="">
                            </span>
                    ...
                    <div class="row advantages_rows">
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-4.svg')); ?>"
                                     alt="">
                            </span>
                        ...
                        <div class="col-lg-6 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-4.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row advantages_rows">
                        <div class="col-lg-6 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-5.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-5.svg')); ?>"
                                     alt="">
                            </span>
                    ...
                    <div class="row advantages_rows">
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-6.svg')); ?>"
                                     alt="">
                            </span>
                        ...
                        <div class="col-lg-6 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-6.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row advantages_rows">
                        <div class="col-lg-6 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-7.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-7.svg')); ?>"
                                     alt="">
                            </span>
                    ...
                    <div class="row advantages_rows">
                        <div class="col-lg-5 col-md-6">
                            <div class="advantages_item_info">
                            <span>
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-8.svg')); ?>"
                                     alt="">
                            </span>
                        ...
                        <div class="col-lg-6 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-item-8.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="pills-features" role="tabpanel" aria-labelledby="pills-features-tab">
                    <div class="row advantages_rows2 pink-after">
                        <div class="col-lg-7 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-1.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                    ...
                    <div class="row advantages_rows2 green-after">
                        ...
                        <div class="col-lg-7 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-2.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row advantages_rows2 blue-after">
                        <div class="col-lg-7 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-3.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                    ...
                    <div class="row advantages_rows2 yellow-after">
                        ...
                        <div class="col-lg-7 col-md-6 item-orders">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-4.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row advantages_rows2 green--after">
                        <div class="col-lg-7 col-md-6">
                            <div class="advantages_item_img">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-5.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-6">
                    ...
                    <div class="row advantages_rows2 blue--after">
                        ...
                        <div class="col-lg-7 col-md-6 item-orders">
                            <div class="advantages_item_img ">
                                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/features-img-6.png')); ?>"
                                     alt="">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <div class="features-profle">
                                                <img
                                                    src="<?php echo e(URL::to('storage/app/public/Frontassets/images/testimonial.jpg')); ?>"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-7 col-md-6">
                                            <div class="features-profle-info">
                                                <span><img
                                                        src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/left-quote.svg')); ?>"
                                                        alt=""></span>
										...
										<label for="plans-1" class="plans-label">
											...
											<div class="plans" onclick="plan='Basic',amount='0';">
												<div class="basicplanimg">
													<img src="<?php echo e(asset('public/asset_front/assets/images/basic.svg')); ?>" class="basic">
												</div>
												<h2>Basic</h2>
												...
												<div class="facilty">
													<div class="facility1">
														<img src="<?php echo e(asset('public/asset_front/assets/images/id_card.svg')); ?>">
														<p>Auflistung auf reserved4you </p>
													</div>
													<div class="facility2">
														<img src="<?php echo e(asset('public/asset_front/assets/images/computer.svg')); ?>">
														<p>Optimiert für mobile Endgeräte</p>
													</div>
													<div class="facility3">
														<img src="<?php echo e(asset('public/asset_front/assets/images/support.svg')); ?>">
														<p> 48h E-Mail Support</p>
													</div>
													<!-- <div class="facility4">
														<img src="<?php echo e(asset('public/asset_front/assets/images/news.svg')); ?>">
														<p>Individueller Newsletter</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/megaphone.svg')); ?>">
									...
									<div class="col-lg-4 col-md-6 ">
										<label for="plans-2" class="plans-label plan-2">
											...
											<div class="plans" onclick="plan='Basic Plus',amount='39.99';">
												<div class="basicplanimg">
													<img src="<?php echo e(asset('public/asset_front/assets/images/basic-plus.svg')); ?>" class="basic">
												</div>
												<h2>Basic Plus</h2>
												...
												<div class="facilty">
													...
													<div class="facility3">
														<img src="<?php echo e(asset('public/asset_front/assets/images/eigner.svg')); ?>">
									...
									<div class="col-lg-4 col-md-6 ">
										<label for="plans-3" class="plans-label plan-3">
											...
											<div class="plans" onclick="plan='Business',amount='79.99';">
												<div class="basicplanimg">
													<img src="<?php echo e(asset('public/asset_front/assets/images/business-plan.svg')); ?>" class="basic">
												</div>
												<h2>Business</h2>
												...
												<div class="facilty">
													...
													<div class="facility2">
														<img src="<?php echo e(asset('public/asset_front/assets/images/profile.svg')); ?>">
														<p>24h E-Mail Support, Live Chat, Telefonsupport</p>
													</div>
													<div class="facility2">
														<img src="<?php echo e(asset('public/asset_front/assets/images/reception.svg')); ?>">
														<p>eigener Admin Bereich</p>
													</div>
													<div class="facility3">
														<img src="<?php echo e(asset('public/asset_front/assets/images/support.svg')); ?>">
													...
													<div class="facility4">
														<img src="<?php echo e(asset('public/asset_front/assets/images/news-letter.svg')); ?>">
														<p>Werbung auf reserved4you + Social Media</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/buchu.svg')); ?>">
														<p>BUCHUNGSSYSTEM</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/manage.svg')); ?>">
														<p>Managementtools</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/koste.svg')); ?>">
														<p>kostenlose Schulung</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/indi-news.svg')); ?>">
														<p>individueller Newsletter</p>
													</div>
													<div class="facility5">
														<img src="<?php echo e(asset('public/asset_front/assets/images/stat.svg')); ?>">
														<p>Statistiken</p>
													</div>
												</div>
												<div class="recruitmentfee">
    ...
    <section class="partner-bg">
        <div class="container">
            <div class="partner-infos">
                <h6><?php echo e(\BaseFunction::getStatisticWebsite('provider')); ?>+ Partner</h6>
...
<?php $__env->startSection('front_js'); ?>
    ...
    todayHighlight : true
		...
		$('.plans-label').click(function() {
			...
			window.location.replace("<?php echo e(url('https://www.reserved4you.de/vertrag')); ?>");
		});
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/Cosmetic/becomePartner.blade.php ENDPATH**/ ?>