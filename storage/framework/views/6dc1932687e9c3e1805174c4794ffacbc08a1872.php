...
<section class="index-banner">
    <div class="index-banner-img">
        <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/index-banner.jpg')); ?>" alt="">
    </div>
    ...
    <div class="cosmetics-box-main">
        ...
        <?php echo e(Form::open(array('url'=>URL::to('cosmetic-area'),'method'=>'GET','name'=>'search_form','class'=>'search_form'))); ?>
        ...
        <div class="cosmetics-box-body">
            ...
            <ul>
                <li class="index-filter-li">
                    ...
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/categories.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    ...
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/store.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    ...
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/pin-2.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    <input class="datepicker" id="datepickerhome" name="date" data-date-format="mm-dd-yyyy" readonly="true"  placeholder="Datum">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/calendar.svg')); ?>" alt=""></span>
                </li>
...
<section class="index-service-section">
    <div class="container">
        <div class="who-r4u-section">
            <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/service-heading-icon.')); ?>svg" alt=""></span>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="pocket-info">
                    ...
                    <ul>
                        <li>
                            <a href="#"><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/play-store.svg')); ?>" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/app-store.svg')); ?>" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 pocket-order-1">
                <div class="pocket-img">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/pocket-phone.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="advantages-home-section padding-100">
    <div class="container">
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-img">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-1.png')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-1.svg')); ?>" alt=""></span>
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-2.svg')); ?>" alt=""></span>
            ...
            <div class="col-lg-6 col-md-6 advantages-ordermd">
                <div class="advantages-home-item-img">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-2.png')); ?>" alt="">
                </div>
            </div>
        </div>
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-img">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-3.png')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-3.svg')); ?>" alt=""></span>
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-4.svg')); ?>" alt=""></span>
            ...
            <div class="col-lg-6 col-md-6 advantages-ordermd">
                <div class="advantages-home-item-img  ">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-4.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <!--<div class="owl-carousel owl-theme" id="digital-main-owl">
            <div class="item">
                <div class="digital-main-partner">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-1.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-2.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-3.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-4.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-5.png')); ?>" alt="">
                </div>
            </div>
        </div> -->
    </div>
...
<section class="index-map-section padding-100">
    ...
    <div class="index-map-image">
        <!-- <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/map.png')); ?>" alt=""> -->
        ...
        <div class="map-info-box">
            <div class="map-store-img">
                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/serimg1.png')); ?>" alt="">
            </div>
    ...
    <!-- <div id="map_info" style="display: none;">
        <div class="map-box">
            <div class="map-box-img">
                <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/pocket-bg.jpg')); ?>" alt="">
            </div>
        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 col-md-6">
                <div class="social-media-img">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>" alt="" class="social_imgs">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
...
<section class="register-cosmetic-section">
    <div class="container">
        <div class="register-cosmetic-areas">
            <span class="register-cosmetic-lines"><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/area-line.svg')); ?>" alt=""></span>
            <span class="register-cosmetic-lines2"><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/area-line.svg')); ?>" alt=""></span>
			<?php if(!Auth::check()): ?>
