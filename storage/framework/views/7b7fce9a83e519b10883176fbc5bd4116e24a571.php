            ...
            <div class="row">
                <div class="col-md-6 col-lg-5 col-xl-6">
                    <div class="adadvantages-banner-box">
                        <h6>Wow!</h6>
                        <p>Wow ! Aktuell haben wir <span> <?php echo e(\BaseFunction::getStatisticWebsite('customer')); ?>+ </span> aktive Nutzer!</p>
                    </div>
                    <div class="adadvantages-banner-info">
                        <h4>Einfach. Schnell. Gebucht..</h4>
                        <p style="text-overflow:unset:overflow:unset;"> Termin per Telefon vereinbaren ? Keine Service Liste mit Preisen verfügbar ? Salon online
                            nicht gefunden ? Termin vergessen ?
                            All das hat jetzt ein Ende.
                            Du willst nichts mehr verpassen und alle Vorteile von reserved4you nutzen können? Los
                            geht’s!</p>
                        <?php if(!Auth::check()): ?>
    ...
    <section class="padding-100 who-r4u-main-section">
        <div class="container">
            <div class="who-r4u-section">
                ...
                <p>Bequem und schnell buchen – das ist der neue Trend. Wie unser System funktioniert?
                    Ganz einfach: Wir schaffen Verbindungen.
                    Und zwar kombinieren wir Buchungen, Übersichtslisten und weitere vorteilhafte Funktionen in mehreren
                    verschiedenen Bereichen.
                    Damit seid ihr für die Zukunft gewappnet.</p>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        ...
                        <div class="advantages-information">
                            ...
                            <h5>Speichere deine Favoriten in deinem Profil.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="advantages-items">
                        ...
                        <div class="advantages-information">
                            ...
                            <h5>Immer und Überall! Nutze die mobile Version oder App auf allen Endgeräten.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="row step-roww step-roww-2">
                <div class="col-sm-6 col-xl-4 order-2 order-sm-1">
                    <div class="step-info step-info-2">
                        <span>Step 2</span>
                        <p>Finde den <span> besten Anbieter, </span> sogar direkt in deiner Nähe.
                        </p>
                    </div>
                </div>
            ...
            <div class="row step-roww step-roww-4">
                <div class="col-sm-6 col-xl-4 order-2 order-sm-1">
                    <div class="step-info step-info-4">
                        <span>Step 4</span>
                        <p> Wähle einen Mitarbeiter für deinen Service aus und vereinbare einen Termin.
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-7 order-1 order-sm-2">
                ...
                <div class="item">
                    <div class="testimonial-items">
                        <div class="testimonial-profile">
                            <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/experts-1.jpg')); ?>"
                                 alt="">
                        ...
                        <div class="testimonial-profile-info">
                            ...
                            <p>Kosmetik Termine buchen war für mich bisher noch nie so einfach wie mit dieser Plattform.
                                Es spart so viel Zeit im Alltag, man hat alle Informationen direkt auf einen Blick und
                                das ganze System ist sehr einfach zu handhaben. Bin super zufrieden und werde in Zukunft
                                meine Termine immer hierüber buchen.</p>
                        </div>
        ...
        <div class="container">
            <div class="register-cosmetic-areas">
                ...
                <div class="register-cosmetic-areas-info">
                    <h6>Registriere dich hier, um alle Vorteile zu nutzen</h6>
                    <?php if(!Auth::check()): ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/Front/Cosmetic/cosmeticAdvantages.blade.php ENDPATH**/ ?>