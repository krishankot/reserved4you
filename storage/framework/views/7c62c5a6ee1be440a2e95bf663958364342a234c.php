...
<?php $__env->startSection('front_content'); ?>
            ...
            <div class="tab-content owl-buttons" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-new" role="tabpanel" aria-labelledby="pills-new-tab">
                    <div class="owl-carousel owl-theme" id="new-area-owl">
                        <?php $__empty_1 = true; $__currentLoopData = $new_store; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="item" onclick="window.location.href='<?php echo e(URL::to('cosmetic/'.$row['slug'])); ?>'" style="cursor: pointer;">
                                <div class="area-banner-item">
                                    ...
                                    <div class="area-banner-item-info">
                                        <p class="review-box"><span><i class="fas fa-star"></i></span><?php echo e($row->rating); ?>

                                        </p>
                                        <h6 data-toggle="tooltip" data-placement="bottom"
                                            title="<?php echo e($row->store_name); ?>"><?php echo e($row->store_name); ?></h6>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-recommended" role="tabpanel"
                    ...
                    <div class="owl-carousel owl-theme" id="recommended-area-owl">
                        <?php $__empty_1 = true; $__currentLoopData = $recommandedforyou; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="item" onclick="window.location.href='<?php echo e(URL::to('cosmetic/'.$row['slug'])); ?>'" style="cursor: pointer;">
                                <div class="area-banner-item">
                                    <div class="area-banner-item-img">
                                        <img
                ...
                <div class="tab-pane fade" id="pills-rated" role="tabpanel" aria-labelledby="pills-rated-tab">
                    <div class="owl-carousel owl-theme" id="rated-area-owl">
                        <?php $__empty_1 = true; $__currentLoopData = $high_rate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="item" onclick="window.location.href='<?php echo e(URL::to('cosmetic/'.$row['slug'])); ?>'" style="cursor: pointer;">
                                <div class="area-banner-item">
                                    <div class="area-banner-item-img">
                                        <img
        ...
        <div class="container">
            <ul class="area-filter-wrap">
                <li class="w-17">
                    ...
                    <?php echo e(Form::select('categories',$category,$categorieData,array('class'=>'main_cate select'))); ?>

                </li>
                <li class="w-20">
                    <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/categories.svg')) ?></span>
                    <?php echo e(Form::select('sab_cat',$subCategory,$sub_cat,array('class'=>'sub_cat select'))); ?>
                ...
                <li class="w-16">
                    ...
                    <input type="text" id="autocomplete" name="location" autocomplete="off" placeholder="PLZ oder Ort suchen" value="<?php echo e($location); ?>">
                    <input type="hidden" id="distric" name="distric" autocomplete="off" value="<?php echo e($distric); ?>" placeholder="Post code or area">
                    <input type="hidden" id="postal_code" name="postal_code" autocomplete="off" value="<?php echo e($pincode); ?>" placeholder="Post code or area">
					<input type="hidden" id="search_type" name="search_type" value="<?php echo e($search_type); ?>">
					<input type="hidden" id="search_el" name="search_el" value="<?php echo e($search_el); ?>">
                </li>
                <li class="w-17">
    ...
    <section class="filter-wrap-main">
        <div class="container">
            <div class="filter-wrap">
                <p><span class="total_store"><?php echo e(count($getStore)); ?></span> Suchergebnisse</p>
        ...
        <div class="container">
            <div class="row google-rowws">
                ...
                <div class="col-lg-7 search_div">
                    <?php $__empty_1 = true; $__currentLoopData = $getStore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $ids[] = $row->id; ?>
                        <div class="area-item-wrap" onmouseenter="showme(<?php echo $key; ?>);">
                            <div class="area_img">
                            ...
                            <div class="area_info">
                                ...
                                <div class="area_info_rating_wrap">
                                    ...
                                    <p><?php echo e(\BaseFunction::finalRating($row->id)); ?> <span> (<?php echo e(@$row->storeRated->count()); ?> Bewertungen)</span>
                                    </p>
                                </div>
                                <ul class="area_tag">
                                    <?php $__empty_2 = true; $__currentLoopData = @$row->storeCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            ...
                            <div class="area_price">
                                <a class="wishlist_icon <?php echo e($row->isFavorite == 'true' ? 'active' : ''); ?>"
                                   data-id="<?php echo e($row['id']); ?>" href="javascript:void(0)"><i class="far fa-heart"></i></a>
                                                    ...
                                                    <li>
                                                        <div class="custom-control custom-checkbox area-checkbox">
                                                            <input type="checkbox"
                                                                   ...
                                                                   id="areacustomCheck<?php echo e($feature['id']); ?>">
                                                            <label class="custom-control-label"
                                                                   for="areacustomCheck<?php echo e($feature['id']); ?>"><?php echo e($feature['name']); ?></label>
                                                        </div>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <?php endif; ?>
    ...
    <input type="hidden" name="stores" id="store_ids" value="<?php echo e(isset($ids)?implode(',',$ids):''); ?>">
...
<?php $__env->startSection('front_js'); ?>
    ...
    <script type="text/javascript">
        ...
        var date = new Date('<?php echo e($date); ?>');
        ...
        function changeMainC() {
            var cat = '<?php echo e($categorieData); ?>';
            var sub = '<?php echo e($sub_cat); ?>';
            if (cat != '' || sub != '') {
                $.ajax({
                    type: 'GET',
        ...
        $(".serach_btn").on('click', function () {
            ...
            $.ajax({
                type: 'POST',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                url: "<?php echo e(URL::to('cosmetic-area')); ?>",
                beforesend: $('#loading').css('display', 'block'),
                data: data,
                success: function (response) {
        ...
        function updateSearch(data, is_filter = '') {
            ...
            $.each(data, function (i, row) {
                ids = ids + ',' + row.id;
                var html = `<div class="area-item-wrap" onmouseenter="showme(`+i+`);"><div class="area_img"><div class="owl-carousel owl-theme area-img-owl" id="area-img-owl` + row.id + `" class="area-img-owl"><div class="item" onclick="window.location.href='` + baseurl + `/cosmetic/` + row.slug + `'"><div class="area-img">`;
                html += `<img src="<?php echo e(URL::to('storage/app/public/store/')); ?>` + '/' + ((row.store_profile == null) ? 'Store-6058bde8bf5a8.JPEG' : row.store_profile) + `" alt="">`;
                html += `</div></div>`;
                $.each(row.storeGallery, function (j, cat) {
                    html += `<div class="item" onclick="window.location.href='` + baseurl + `/cosmetic/` + row.slug + `'"><div class="area-img">`;
                    html += `<img src="<?php echo e(URL::to('storage/app/public/store/')); ?>` + '/' + ((row.store_profile == null) ? 'Store-6058bde8bf5a8.JPEG' : row.store_profile) + `" alt="">`;
                    html += `</div></div>`;
                });
                ...
                html += `<h6 onclick="window.location.href='` + baseurl + `/cosmetic/` + row.slug + `'">` + row.store_name + `</h6>`;
                ...
                // $.getScript("<?php echo e(URL::to('storage/app/public/Frontassets/js/owl.carousel.min.js')); ?>");
        ...
        $('.sort_data').on('change', function () {
            ...
            if (ord != "") {
                $.ajax({
                    ...
                    async: true,
                    dataType: "json",
                    url: "<?php echo e(URL::to('sort-data')); ?>",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        ids: ids,
                        ord: ord
    ...
    <script type="text/javascript">
        ...
        function map_pin(data) {
           ...
           var infowindow = new google.maps.InfoWindow();
            ...
            for (var i = 0; i < beaches.length; i++) {
				...
				var cicon = '<?php echo e(asset("storage/app/public/Frontassets/images/stars/")); ?>/'+filename;
                ...
                google.maps.event.addListener(newMarker, 'click', (function (newMarker, i) {
					var storeprofileimg = "<?php echo e(URL::to('storage/app/public/store/')); ?>" + '/' + ((beaches[i]['store_profile'] == null) ? 'Store-6058bde8bf5a8.JPEG' : beaches[i]['store_profile'])
					if (beaches[i]['store_profile'] != "") {
						$.ajax({
							...
							error: function() 
							{
								storeprofileimg = "<?php echo e(URL::to('storage/app/public/store/')); ?>" + '/Store-6058bde8bf5a8.JPEG';
							},
							success: function() 
							{
								storeprofileimg = "<?php echo e(URL::to('storage/app/public/store/')); ?>" + '/'+beaches[i]['store_profile'];
							}
						});
					} else {
						storeprofileimg = "<?php echo e(URL::to('storage/app/public/store/')); ?>" + '/Store-6058bde8bf5a8.JPEG';
					...
					return function () {
						var infobox_html = "";
						var store_url = "<?php echo e(url('cosmetic')); ?>/"+beaches[i]['slug'];
		...
		showme = function (index) {
			...
			var filename = "star_"+rating+".svg";
			var vicon = '<?php echo e(asset("storage/app/public/Frontassets/images/select_stars/")); ?>/'+filename;
        ...
        $('.btn-filter').on('click', function () {
            ...
            $.ajax({
                ...
                async: true,
                dataType: "json",
                url: "<?php echo e(URL::to('filter-data')); ?>",
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    ids: ids,
                    price: price,
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/Front/Cosmetic/cosmeticArea.blade.php ENDPATH**/ ?>