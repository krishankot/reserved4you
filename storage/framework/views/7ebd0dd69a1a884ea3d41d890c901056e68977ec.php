...
<head>
    ...
    <link type="image/x-icon" rel="shortcut icon"
          href="<?php echo e(URL::to('storage/app/public/Frontassets/images/favicon.jpg')); ?>"/>
    <!-- Required meta tags -->
    <meta charset="UTF-8"/>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo e(URL::to('storage/app/public/rateit/rateit.css')); ?>"/>
	<style>
        ...
        <div class="container">
            <div class="heading d-flex justify-content-between flex-wrap">
                <a class="navbar-brand logo" href="<?php echo e(URL::to('/')); ?>">
                    <img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/logo.svg')); ?>" alt="logo">
                </a>
...
<?php echo e(Form::open(array('url'=>'submit-rating','name'=>'submit-rating','id'=>'submit_rating','method'=>'post'))); ?>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="feedback-select">
					<?php if(!empty($ap_id)): ?>
						 <input type="hidden" name="ap_dataid" value="<?php echo e($ap_id); ?>">
						<?php endif; ?>
                     <?php if($service_id != '' && $service_id != null): ?>
                    <a href="javascript:void(0)" class="feedback-select-link">
                        <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/chair.svg')); ?>"
                                   alt="" class="str_image"></span>
                       
                            <p class="str_name"><?php echo e($serviceName); ?></p>
                            <input type="hidden" name="service_id" value="<?php echo e($service_id); ?>" class="service_names">
                        
                        <input type="hidden" name="store_id" value="<?php echo e($store['id']); ?>" class="store_id">
                    </a>
                    <?php else: ?> 
                                    ...
                                    <div class="card-body store-body store-body2">
                                        <div class="owl-carousel owl-theme" id="service-item-owl2">
                                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item">
                                                    <label class="service-labels-2 " for="service-item-<?php echo e($row->id); ?>" >
                                                        <input type="radio" name="service-item-span" class="service_lbl"
                                                               id="service-item-<?php echo e($row->id); ?>" value="<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>" data-image="<?php echo e(URL::to('storage/app/public/category/' . $row->image)); ?>">
            ...
            <div class="col-lg-6">
                <div class="feedback-select">
                     <?php if($emp != '' && $emp != null): ?>
                    <a href="javascript:void(0)" class="feedback-select-link">
                        <span><img src="<?php echo e($empimage); ?>"
                                   alt="" class="emp_image"></span>
                        <p class="emp_name"><?php echo e($empname); ?></p>
                        <input type="hidden" name="emp_id" value="<?php echo e($emp); ?>" class="emp_names">
                    </a>
                    <?php else: ?> 
                     <a href="javascript:void(0)" class="feedback-select-link" data-toggle="modal"
                       data-target="#selectEmployeeModal">
                        <span><img src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/outstanding.svg')); ?>"
                                   alt="" class="emp_image"></span>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="servic-modal-body feedback-modal-body">
                                    ...
                                    <ul class="employee-profile-ul">
                                        <li>
                                            <?php $__currentLoopData = $storeEmp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="employee_profiles" for="employee-profiles-<?php echo e($row->id); ?>"
                                                       data-name="<?php echo e($row->emp_name); ?>"
                                                       data-image="<?php echo e(URL::to('storage/app/public/store/employee/'.$row->image)); ?>">
                                                    <input type="radio" name="employee-profile" value="<?php echo e($row->id); ?>"
                                                           id="employee-profiles-<?php echo e($row->id); ?>">
                                                    <div>
                                                        <span class="profile-spann">
                                                            <img
                                                                src="<?php echo e(URL::to('storage/app/public/store/employee/'.$row->image)); ?>"
                                                                alt="">
                                                        </span>
                                                        <p><?php echo e($row->emp_name); ?></p>
...
<script src="<?php echo e(URL::to('storage/app/public/rateit/jquery.rateit.js')); ?>"></script>
...
<script>
    ...
    $(document).on('click','.clear_emp',function (){
        ...
        $('.emp_names').val('');
        var image = "<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/outstanding.svg')); ?>";
...
<?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/User/feedback.blade.php ENDPATH**/ ?>