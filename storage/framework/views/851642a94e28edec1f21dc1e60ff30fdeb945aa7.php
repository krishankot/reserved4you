...
<?php $__env->startSection('service_content'); ?>
    <div class="main-content">
        ...
        <div class="setting-title">
            ...
            <a href="<?php echo e(URL::to('service-provider/logout')); ?>" class="btn btnyellow cancelbtn btn-yellow">Logout</a>
        </div>
        ...
        <div class="store-profile-width setting-width">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show" id="pills-change-pswrd" role="tabpanel"
                    ...
                    <?php echo e(Form::open(array('url'=>'service-provider/change-password','method'=>'post','name'=>'change-password','class'=>'change-passowrd-form'))); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="change-pswrd-input">
                                    <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/lock.svg')); ?>"
                                         alt="">
                                    <input type="password" name="old_password" class="<?php $__errorArgs = ['old_password'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Old password" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="change-pswrd-input">
                                    <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/lock.svg')); ?>"
                                         alt="">
                                    <input type="password" name="new_password" class="<?php $__errorArgs = ['new_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="change-pswrd-input">
                                    <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/lock.svg')); ?>"
                                         alt="">
                                    <input type="password" class="<?php $__errorArgs = ['confirm_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="confirm_password" placeholder="Confirm password" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="contact-us-pills">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="setting-contact-info">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="setting-call-info mt-4">
												<img
													src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/setting-phone.svg')); ?>"
													alt="">
													<div class="phone-num">
													<h6>Telefonnummer </h6>
										...
										<div class="col-md-6">
											<div class="setting-msg-info mt-4">
												<img
													src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/setting-msg.svg')); ?>"
													alt="">
													<div class="phone-num">
													<h6>E-Mail</h6>
                                    ...
                                    <!-- <div class="setting-location-info">
                                        <img
                                            src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/setting-location.svg')); ?>"
                                            alt="">
                                        <p>1.st Floor, Vorderhaus Gaststätte</p>
                                    </div> -->
                                   <!-- <div class="setting-logo">
                                        <img
                                            src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/setting-logo.svg')); ?>"
                                            alt="">
                                    </div> -->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 d-none">
                                <form class="setting-about-form" action="<?php echo e(URL::to('service-provider/contact-us')); ?>" method="POST" name="contact_form">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="contact-chat">
                                        ...
                                        <div class="msg-send">
                                            ...
                                            <a href="#">  <img
                                            src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/setting/send.svg')); ?>"
                                            alt=""></a>
                                        </div>
                                    </div>
                                <!-- <div class="row">
                                    <div class="col-lg-12">
                                        <input type="text" name="name" placeholder="First name" value="<?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?>" required class="about-fname">
                                    </div>

                                    <div class="col-lg-12">
                                        <input type="text" name="email" placeholder="Email address" value="<?php echo e(Auth::user()->email); ?>" required class="about-fname">
                                    </div>
                                    <div class="col-lg-12">
                ...
                <div class="tab-pane fade show" id="pills-substription-us" role="tabpanel"
                    ...
                    <div class="substition">
                        ...
                        <h5 class="mt-2"><?php echo e($plan->store_name); ?></h5>
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="sub-payment-plan mb-1">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="sub-plan">
                                                <p>Subscribed Plan</p>
                                                <h5><?php echo e($plan->plan_name); ?></h5>
                                            </div>
                                            <div class="sub-plan-time">
                                                <p>Plan time</p>
                                                <h6>
                                                    <?php if(str_contains($plan->store_active_actual_plan, 'monthly')): ?>
                                                        Monthly
                                                    <?php else: ?>
                                                        Annual
                                                    <?php endif; ?>
                    ...
                    <?php if(!empty($extraService)): ?>
                        <?php $__currentLoopData = $extraService; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <ul class="service-plans">
                            <h6 class="d-block w-100 mt-2"><?php echo e($key); ?></h5>
                            <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="dashboard-box gray-box">
                                        <span>
                                            <?php if(str_contains($service->Service_plan, 'Rabatte für Kunden')): ?>
                                                <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/icon/discount.svg')); ?>" alt="">
                                            <?php else: ?>
                                                <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/icon/card.svg')); ?>" alt="">
                                            <?php endif; ?>
                                        </span>
                                        <p><?php echo e($service->plan_type); ?></p>
                                
                                        <h6><?php echo e($service->Service_plan); ?></h6>
                                        <h5>
                                            <?php echo e($service->Service_amount); ?>

                                            <?php echo e((str_contains($service->Service_amount, '%') != false) ?  '' : '€'); ?> 
                                            <?php if($service->plan_type != "onetime"): ?>
                                                / mo
                                            <?php endif; ?>
                                        </h5>
                                    </div>
                    ...
                    <?php if(count($hardware) > 0): ?>
                        ...
                        <?php $__currentLoopData = $hardware; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <ul class="service-plans">
                            <h6 class="d-block w-100 mt-2"><?php echo e($key); ?></h5>
                            <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="dashboard-box gray-box">
                                        <span>
                                            <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/icon/hardware-phone.svg')); ?>" alt="">
                                        </span>
                                        <p><?php echo e($service->plan_type); ?></p>
                    ...
                    <?php if(count($paymentDetail) > 0): ?>
                        <?php $__currentLoopData = $paymentDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card-payment">
                                <div class="card-icon">
                                    <img src="<?php echo e(asset('storage/app/public/Serviceassets/images/icon/cust-card.svg')); ?>" alt="">
                                </div>
                                <div class="card-type">
                                    <p>Card Type</p>
                                    <h5><?php echo e($row->payment_method); ?></h5>
                                </div>
                                <div class="card-type">
                                    <p>Card holder name</p>
                                    <h5><?php echo e($row->card_holder_name); ?></h5>
                                </div>
                                <div class="card-type">
                                    <p>Credit card</p>
                                    <h5><?php echo e(substr($row->card_number, 0, 4)); ?>  . . . .   . . . .  <?php echo e(substr($row->card_number, -4, 4)); ?></h5>
                                </div>
                    ...
                    <?php if(count($invoices) > 0): ?>
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $allInvoices): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h6 class="d-block w-100 mt-2"><?php echo e($key); ?></h5>
                            <?php if(count($allInvoices) > 0): ?>
                                <?php $__currentLoopData = $allInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card-payment card-pay-pdf row">   
                                        <div class="card-icon-pdf col-3 col-sm-1 px-0">
                                            <img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/icon/pdf-icon.svg')); ?>" alt="">
                                        </div>
                                        
                                        <div class="card-type card-info mr-0 col-9 col-sm-5">
                                            <p>Name of invoice file</p>
                                            <h5><?php echo e($row->title .'.pdf'); ?></h5>
                                            <p>
                                                Status: 
                                                <?php if($row->status=="open"): ?>
                                                    <button disabled class="btn btn_status btn-outline-info"><?php echo e($row->status); ?></button>
                                                <?php elseif($row->status == "cancelled"): ?> 
                                                    <button disabled class="btn btn_status btn-outline-danger"><?php echo e($row->status); ?></button>
                                                <?php elseif($row->status == "due"): ?> 
                                                    <button disabled class="btn btn_status btn-outline-warning"><?php echo e($row->status); ?></button>
                                                <?php elseif($row->status == "paid"): ?> 
                                                    <button disabled class="btn btn_status btn-outline-success"><?php echo e($row->status); ?></button>
                                                <?php elseif($row->status == "in arrears"): ?> 
                                        ...
                                        <div class="card-type card-info mr-0 col-6 col-sm-2 mt-3 mt-sm-0">
                                            <p>Invoice Number</p>
                                            <h5><?php echo e($row->invoice_number); ?></h5>
                                        </div>
                                        <div class="card-type col-6 col-sm-2 mt-3 mt-sm-0">
                                            <p>Date of invoice</p>
                                            <h5><?php echo e(\Carbon\Carbon::parse($row->created_at)->format('M d, Y')); ?></h5>
                                        </div>
                                        <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                                            <div class="btn-download">
                                                <?php if($row->bill_type == 'payout'): ?>
                                                    <a target="_blank" href="<?php echo e(route('payout.download', ['id' => $row->id, 'number' => $row->invoice_number])); ?>">Download</a>
                                                <?php else: ?> 
                                                    <a target="_blank" href="<?php echo e(route('invoice.download', ['id'=>$row->id, 'number'=>$row->invoice_number])); ?>">Download</a>
                                                <?php endif; ?>
                    ...
                    <div class="setting-about-us">
						...
						<div class="row">
							<div class="col-md-6 mb-4">
								 ...
								 <video width="100%"  poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Login.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6 mb-4">
								 <h6>How to # 1 Dashboard</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Dashboard.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 2 Kalender</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Kalender.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 3 Buchungen</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Buchungen.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 4 Kunden</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Kunden.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 5 Mitarbeiter</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Mitarbeiter.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 6 Betriebsprofil</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Betriebsprofil.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 7 Statistiken</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Statistiken.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 8 Finanzen</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Finanzen.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
							<div class="col-md-6  mb-4">
								 <h6>How to # 9 Einstellungen</h6>
								 <video width="100%" poster="<?php echo e(asset('storage/app/public/Serviceassets/videos/banner.png')); ?>" controls>
									  <source src="<?php echo e(asset('storage/app/public/Serviceassets/videos/Einstellungen.mp4')); ?>" type="video/mp4">
								</video> 
							</div>
						</div>
					</div>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Setting/index.blade.php ENDPATH**/ ?>