        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('kosmetik-bereiche') ? 'active' : ''); ?>" href="<?php echo e(route('kosmetic.search')); ?>">Bereiche</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('kosmetik-deine-vorteile') ? 'active' : ''); ?>" href="<?php echo e(URL::to('/kosmetik-deine-vorteile')); ?>">Deine Vorteile</a>
                    </li>
                    <?php if(!Auth::check()): ?>
                        <li class="nav-item">
                            <a class="nav-link btn become-btn btn-business <?php echo e(Request::is('geschaeftspartner') ? 'active' : ''); ?>" href="<?php echo e(URL::to('geschaeftspartner')); ?>">Geschäftspartner</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::is('geschaeftspartner') ? 'active' : ''); ?> btn btn-business" href="<?php echo e(URL::to('geschaeftspartner')); ?>">Geschäftspartner</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-new-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a href="<?php echo e(route('users.profile')); ?>" class="h-dropdown-item-wrap">Mein Profil <i class="fas fa-chevron-right"></i></a>
                                <a href="<?php echo e(route('users.settings')); ?>" class="h-dropdown-item-wrap">Einstellungen <i
                                        class="fas fa-chevron-right"></i></a>
                                <a href="<?php echo e(route('users.notifications')); ?>" class="h-dropdown-item-wrap">Mitteilungen <i
                                        class="fas fa-chevron-right"></i></a>
                                <a href="<?php echo e(route('users.logout')); ?>" class="h-dropdown-item-wrap logout-header">Logout <i
                                        class="fas fa-chevron-right"></i></a>
                            </div>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Includes/Front/header.blade.php ENDPATH**/ ?>