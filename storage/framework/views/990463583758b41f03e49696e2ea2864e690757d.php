...
<?php $__env->startSection('service_content'); ?>
    <div class="main-content">
        <div class="page-title-div">
            ...
            <p><a href="<?php echo e(URL::to('service-provider/store-profile')); ?>">Betriebsprofil</a> <i> / Service hinzufügen</i></p>
        </div>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Service/add_service.blade.php ENDPATH**/ ?>