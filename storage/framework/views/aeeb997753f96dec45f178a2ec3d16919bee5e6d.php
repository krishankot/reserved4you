        ...
        <div class="dashboard-row wallet-row">
		  ...
		  <div class="transaction justify-content-end  mt-3">
			...
			<div class="d-flex align-items-center justify-content-end">
				 <?php echo e(Form::open(array('url'=>"service-provider/wallet",'method'=>'get','name'=>'change_month','id'=>'change_month'))); ?>
   ...
   <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    <script>
		...
		function redirectMoreDetails(id, ap_id){
			...
			window.location.href = "<?php echo e(url('service-provider/customer-details/')); ?>/"+ap_id;
		}
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/Wallet/index.blade.php ENDPATH**/ ?>