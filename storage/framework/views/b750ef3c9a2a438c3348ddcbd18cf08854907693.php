...
<section class="index-banner">
    <div class="index-banner-img">
        <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/index-banner.jpg')); ?>" alt="">
    </div>
    ...
    <div class="cosmetics-box-main">
        ...
        <?php echo e(Form::open(array('url'=>route('kosmetic.search'),'method'=>'GET','name'=>'search_form','class'=>'search_form'))); ?>

        <div class="cosmetics-box-body">
            <div class="owl-carousel owl-theme" id="service-item-owl2">
                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $raw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="item">
                    <label href="javascript:void(0)"
                        class="service-item-icon service-item-icon-index service-item-label" data-id="<?php echo e($raw->id); ?>">
                        <input type="radio" name="categories" class="main_cate" value="<?php echo e($raw->id); ?>">
                        <span><?php echo file_get_contents(URL::to('storage/app/public/category/'.$raw->image)); ?></span>
                        <h6><?php echo e($raw->name); ?></h6>
            ...
            <ul>
                <li class="index-filter-li">
                    ...
                    <?php echo e(Form::select('sub_cat',[''=>'Unterkategorien'],'',array('class'=>'sub_cat','id'=>'sub_cat'))); ?>

                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/categories.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    ...
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/store.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    ...
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/pin-2.svg')); ?>" alt=""></span>
                </li>
                <li class="index-filter-li">
                    <input class="datepicker" id="datepickerhome" name="date" data-date-format="mm-dd-yyyy" readonly="true"  placeholder="Datum">
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/calendar.svg')); ?>" alt=""></span>
                </li>
...
<section class="index-service-section">
    <div class="container">
        <div class="who-r4u-section">
            <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/service-heading-icon.')); ?>svg" alt=""></span>
        ...
        <ul class="catagory-item-ull">
            <li class="catagory-item-1">
                <a href="javascript:void(0)" class="before-catagory">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/category-before-1.')); ?>svg" alt="">
                </a>
            </li>
            <li class="catagory-item-2">
                <a href="javascript:void(0)" class="after-catagory">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/category-2.svg')); ?>" alt="">
                </a>
                <h6>Kosmetik</h6>
            </li>
            <li class="catagory-item-3">
                <a href="javascript:void(0)" class="before-catagory">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/category-before-3.svg')); ?>" alt="">
                </a>
            </li>
            <li class="catagory-item-4">
                <a href="javascript:void(0)" class="before-catagory">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/category-before-4.svg')); ?>" alt="">
                </a>
            </li>
        </ul>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="pocket-info">
                    ...
                    <ul>
                        <li>
                            <a href="#"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/play-store.svg')); ?>" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/app-store.svg')); ?>" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 pocket-order-1">
                <div class="pocket-img">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/pocket-phone.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="advantages-home-section padding-100">
    <div class="container">
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-img">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-1.png')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-1.svg')); ?>" alt=""></span>
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-2.svg')); ?>" alt=""></span>
            ...
            <div class="col-lg-6 col-md-6 advantages-ordermd">
                <div class="advantages-home-item-img">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-2.png')); ?>" alt="">
                </div>
            </div>
        </div>
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-img">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-3.png')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-3.svg')); ?>" alt=""></span>
        ...
        <div class="row advantages-home-row">
            <div class="col-lg-6 col-md-6">
                <div class="advantages-home-item-info">
                    <span><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/icon/advantages-home-icon-4.svg')); ?>" alt=""></span>
            ...
            <div class="col-lg-6 col-md-6 advantages-ordermd">
                <div class="advantages-home-item-img  ">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/advantages-home-4.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="digital-main-section">
    <div class="container">
        ...
        <ul class="digital-main-ul">
            <li>
                <h5><?php echo e(\BaseFunction::getStatisticWebsite('provider')); ?>+</h5>
                <p>Geschäftspartner</p>
            </li>
            <li>
                <h5><?php echo e(\BaseFunction::getStatisticWebsite('appointments')); ?>+</h5>
                <p>gebuchte Termine</p>
            </li>
            <li>
                <h5><?php echo e(\BaseFunction::getStatisticWebsite('customer')); ?>+</h5>
                <p>Nutzer</p>
            </li>
        </ul>
        <!--<div class="owl-carousel owl-theme" id="digital-main-owl">
            <div class="item">
                <div class="digital-main-partner">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-1.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-2.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-3.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-4.png')); ?>" alt="">
                </div>
            </div>
            <div class="item">
                <div class="digital-main-partner">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/client-5.png')); ?>" alt="">
                </div>
            </div>
        </div> -->
    </div>
...
<section class="index-map-section padding-100">
    ...
    <div class="index-map-image">
        <!-- <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/map.png')); ?>" alt=""> -->
        ...
        <div class="map-info-box">
            <div class="map-store-img">
                <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/serimg1.png')); ?>" alt="">
            </div>
            <div class="map-store-info">
                <h5>Berlin</h5>
                <p>100 <span> Partner</span></p>
                <h6>Bezirke</h6>
                <p><span><?php echo e(__('wir sind in')); ?> </span> Charlottenburg-Wilmersdorf, Friedrichshain-Kreuzberg, Lichtenberg, Marzahn-Hellersdorf, Mitte, Neukölln, Pankow, Reinickendorf, Spandau, Steglitz-Zehlendorf, Tempelhof-Schöneberg, Treptow-Köpenick <!--<a href="#">+30 More</a>--></p>
    ...
    <!-- <div id="map_info" style="display: none;">
        <div class="map-box">
            <div class="map-box-img">
                <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/pocket-bg.jpg')); ?>" alt="">
            </div>
            <div class="map-box-info">
                <h6>Thuringia</h6>
                <p>26,520 <span>Business Partner</span></p>
                <h6>Cities</h6>
                <p class="mb-0"><span>We are in </span> <?php echo e($cities); ?></p>
                <a href="#">+30 More</a>
            </div>
        </div>
    </div> -->
        ...
        <div class="row align-items-center ">
            <div class="col-lg-6 col-md-6">
                <div class="social-media-img">
                    <img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>" alt="" class="social_imgs">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="soical-media-info">
                    ...
                    <ul class="soical-media-ul">
                        <li class="instagram scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
                            <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/instagram.svg')); ?></span>
                            <h6>Instagram</h6>
                        </li>
                        <li class="active facebook scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
                            <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/facebook.svg')); ?></span>
                            <h6>Facebook</h6>
                        </li>
                        <li class="tiktok scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
                            <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/tiktok.svg')); ?></span>
                            <h6>TikTok</h6>
                        </li>
                        <li class="snapchat scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
                            <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/snapchat.svg')); ?></span>
                            <h6>Snapchat</h6>
                        </li>
                        <li class="linkedin scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
                            <span><?php echo file_get_contents(URL::to('storage/app/public/Frontassets/images/icon/linkedin.svg')); ?></span>
                            <h6>Linkedin</h6>
                        </li>
                        <li class="whatsapp scl_img" data-url="<?php echo e(URL::to('storage/app/public/Frontassets/images/facebook.png')); ?>">
...
<section class="register-cosmetic-section">
    <div class="container">
        <div class="register-cosmetic-areas">
            <span class="register-cosmetic-lines"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/area-line.svg')); ?>" alt=""></span>
            <span class="register-cosmetic-lines2"><img loading="lazy" src="<?php echo e(URL::to('storage/app/public/Frontassets/images/area-line.svg')); ?>" alt=""></span>
			<?php if(!Auth::check()): ?>
...
<script type="text/javascript">
    ...
    $('.main_cate').on('click',function(){
        ...
        $.ajax({
          ...
          url: "<?php echo e(URL::to('get_sub_cat')); ?>",
          data: {cat:cat},
    ...
    $('.sub_cat').on('change',function(){
        ...
        $.ajax({
          type: 'GET',
          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
          url: "<?php echo e(URL::to('get_stores')); ?>",
    ...
    $(document).on('keyup', '#search_data', function () {
            ...
            if (search.length >= 3) {
                $.ajax({
                    ...
                    async: true,
                    dataType: "json",
                    url: "<?php echo e(URL::to('get-search-data')); ?>",
                    data: {
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/Cosmetic/index.blade.php ENDPATH**/ ?>