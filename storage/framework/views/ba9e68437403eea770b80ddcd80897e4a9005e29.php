        ...
        <div class="employee-list">
            ...
            <div class="employee-list-1">
                <div class="employee-info">
                    ...
                    <a href="<?php echo e(URL::to('dienstleister/mitarbeiter-details/'.encrypt($row['id']))); ?>" class="employeeicon"><img src="<?php echo e(URL::to('storage/app/public/Serviceassets/images/earning-employe/foreign.svg')); ?>"></a>
                </div>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/ServiceProvider/Statistics/index.blade.php ENDPATH**/ ?>