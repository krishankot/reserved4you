                    ...
                    <div class="card-body p-0">
                        <div class="col-3" style="position:absolute;top: 11px">
                            <select class="form-control bg-white store_category" style="width: 90%;">
                                ...
                                <?php $__currentLoopData = $storeProfiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($store->id); ?>" <?php echo e($store->id==session('store_id')?'selected':''); ?>><?php echo e($store->store_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <input type="hidden" id="selectedDat" value="<?php echo e(date('N')); ?>">
                        <input type="hidden" id="selectedMonth" value="<?php echo e(date('m')); ?>">
						 <div class="col-3" style="position:absolute;top: 20px;right:120px;">
						<a href="<?php echo e(url('dienstleister/buchung-erstellen')); ?>" class="appointment-btn ml-auto btn-yellow">Neuen Termin hinzufügen</a>
						</div>
                                    ...
                                    <div>
                                        ...
                                        ?>
										 <?php if(file_exists(storage_path('app/public/store/employee/'.$employee->image)) && $employee->image != ''): ?>
											<img style="height: 60px;width: 60px!important;" class="rounded-circle m-auto slider-change" data-id="<?php echo e($employee->id); ?>" src="<?php echo e(URL::to('storage/app/public/store/employee/'.$image)); ?>" >
										<?php else: ?>
											<img style="height: 60px;width: 60px!important;" class="rounded-circle m-auto slider-change" data-id="<?php echo e($employee->id); ?>" src="https://via.placeholder.com/1080x1080/00000/FABA5F?text=<?php echo e(strtoupper(substr($employee->emp_name, 0, 2))); ?>" alt="">
											
										<?php endif; ?>
                                        
                                        <p class="mb-0 font-weight-bold text-dark  text-center" ><?php echo e($employee->emp_name); ?></p>
                                        <p class="mb-0 font-weight-bold text-center f11 working-time" <?php $__currentLoopData = $employee->EmpTimeSlot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> data-<?php echo e($slot->day); ?>="<?php echo e($slot->start_time.'-'.$slot->end_time); ?>"  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                                            Arbeitszeit <?php $__currentLoopData = $employee->EmpTimeSlot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo e($slot->day==date('l')? $slot->start_time.'-'.$slot->end_time:''); ?>
	...
	<div class="modal fade" id="breakHoursModal" tabindex="-1" role="dialog" aria-labelledby="breakHoursModal" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<?php echo e(Form::open(array('url'=>'service-provider/add-break-hours','method'=>'post','name'=>'form_break_hours','id'=>'form_break_hours','files'=>'true'))); ?>

					
					<div class="store-modal-body">
						<h5>Pausenzeiten</h5>
						<div class="form-group">
							<?php echo e(Form::select('break_store_emp_id', $employee_pluck, NULL,array('reuired', 'class'=>'select select-time'))); ?>

						</div>

						<div class="form-group">
							<input type="text" data-id="modal_add" placeholder="Datum auswählen" class="break_day datepicker consumer-input mb-0" value="<?php echo e(\Carbon\Carbon::now()->format('d/m/Y')); ?>" name="breaks_day">
						</div>
...
<?php $__env->startSection('service_js'); ?>
    ...
    <script>
        $(document).ready(function () {
			...
			?>
			var firstHour =  "<?php echo $firstHourB; ?>";
                ...
                return {
                    ...
                    init: function() {
                        ...
                        calendar = new FullCalendar.Calendar(calendarEl, {
                            ...
                            resources: [
                                    <?php for($i=0;$i<4;$i++): ?>
                                    <?php if(isset($employees[$i]->id)): ?>

                                { id: '<?php echo e($employees[$i]->id); ?>', title: '<?php echo e($employees[$i]->emp_name); ?>',order: "<?php echo e($i); ?>"},
                                <?php endif; ?>
                                <?php endfor; ?>
                            ],
                            ...
                            events: [
									<?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 <?php $__currentLoopData = $emp->EmpBreakSlot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breakslot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($breakslot->everyday == 'on'): ?>	
										{
											<?php
											...
											?>
											resourceId:'<?php echo e($breakslot->store_emp_id); ?>',
											title:'Break',
											startTime :'<?php echo e($breakslot->start_time); ?>',
											endTime:'<?php echo e($breakslot->end_time); ?>',
											className: " text-dark break employee employee-<?php echo e($breakslot->store_emp_id); ?>",
											description: 'breaks',
											extendedProps: {

												status:'Pause',
												appointmentId:'<?php echo e($breakslot->id); ?>',
												duration:'<?php echo e(date(Carbon\Carbon::parse($breakslot->start_time)->format('H:i'))); ?>-<?php echo e(date(Carbon\Carbon::parse($breakslot->end_time)->format('H:i'))); ?>',
												description: 'sdas',
										...
										<?php else: ?>
											{
												...
												resourceId:'<?php echo e($breakslot->store_emp_id); ?>',
												title:'Break',
												start :'<?php echo e($breakslot->day); ?>T<?php echo e($breakslot->start_time); ?>',
												end:'<?php echo e($breakslot->day); ?>T<?php echo e($breakslot->end_time); ?>',
												className: " text-dark break employee employee-<?php echo e($breakslot->store_emp_id); ?>",
												description: 'breaks',
												extendedProps: {
                                    ...
                                    <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $__currentLoopData = $appointment->appointmentDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointmentDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                {
									<?php
										...
										$duration_of_service  = $finishTime->diffInMinutes($startTime);
									?>
                                    resourceId:'<?php echo e($appointmentDetail->store_emp_id); ?>',
                                    title:'<?php echo e($appointment->first_name); ?> <?php echo e($appointment->last_name); ?>',
                                    start :'<?php echo e($appointmentDetail->appo_date); ?>T<?php echo e($appointmentDetail->appo_time); ?>',
                                    end:'<?php echo e($appointmentDetail->appo_date); ?>T<?php echo e($appointmentDetail->app_end_time); ?>',

                                    className: " text-dark <?php echo e($appointmentDetail->status); ?> employee employee-<?php echo e($appointmentDetail->store_emp_id); ?>",
                                    description: '<?php echo e($appointmentDetail->service_name); ?>',
                                    extendedProps: {

                                        status:'<?php if($appointmentDetail->status=='running'): ?> aktiv <?php elseif($appointmentDetail->status=='cancel'): ?> Storniert <?php elseif($appointmentDetail->status=='completed'): ?> Erledigt <?php elseif($appointmentDetail->status=='booked'): ?> Neu <?php else: ?> <?php echo e($appointmentDetail->status); ?> <?php endif; ?>',
                                        appointmentId:'<?php echo e($appointmentDetail->id); ?>',
                                        duration:'<?php echo e(date(Carbon\Carbon::parse($appointmentDetail->appo_time)->format('H:i'))); ?>-<?php echo e(date(Carbon\Carbon::parse($appointmentDetail->app_end_time)->format('H:i'))); ?>',
                                        description: '<?php echo e($appointmentDetail->service_name); ?>',
										 duration_of_service: '<?php echo e($duration_of_service); ?>',
                                    },
                                },
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            $(document).on('click','.slick-arrow',function () {
                ...
                let url='<?php echo e(url('find-appointments')); ?>?ids='+ids+'&date='+dat;
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.change-store').change(function () {
                let val=$(this).val();
                window.location.href="<?php echo e(url('dienstleister/kalender')); ?>?id="+val;
            });
            function removeAllDay() {
    ...
    <script>
        $(document).ready(function () {
			...
			$(document).on('submit', '#form_break_hours', function(e){
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(URL::to('service-provider/add-break-hours')); ?>",
					data:data,
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/ServiceProvider/Calender/calendar.blade.php ENDPATH**/ ?>