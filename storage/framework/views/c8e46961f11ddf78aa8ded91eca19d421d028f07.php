<?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php elseif($row->type == 'rating'): ?>
		<a href="<?php echo e(URL::to('service-provider/store-profile?t=reviews')); ?>">
			<div class="notification-item">
				<div class="noti-heading-wrap">
	...
	<?php elseif($row->type == 'customer_accepted' OR $row->type == 'customer_rejected'): ?>
		<?php if($row->type == 'customer_accepted'): ?>
			<a href="<?php echo e(URL::to('service-provider/customer-details/view/'.encrypt($row->appointment_id))); ?>">
		<?php endif; ?>
		<div class="notification-item">
			<div class="noti-heading-wrap">
		...
		<?php endif; ?>
	<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/html/resources/views/Includes/Service/notificationinner.blade.php ENDPATH**/ ?>