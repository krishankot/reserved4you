                    ...
                    <span>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo e(route('users.settings')); ?>">Passwort ändern</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div class="list-item-top-wrap">
                                                        ...
                                                        <div class="list-item-info">
                                                            <div class="list-item-info-top">
                                                                <h5>
                                                                    <a href="<?php echo e(URL::to('kosmetik/'.@$value['storeData']['slug'])); ?>"><?php echo e(@$value['storeData']['store_name']); ?></a>
                                                                </h5>
                                                                <h6><span><img
                                                        ...
                                                        <div class="list-item-info-top">
                                                            ...
                                                            <h6><span><img
																...
																<?php if(empty($value->is_reviewed)): ?>
																	<a href="<?php echo e(route('users.feedback',['slug' => @$value['storeData']['slug'], 'service_id' => $value['service_id'],'emp' => @$value['empData']['id'], 'ap' => @$value['id']])); ?>">Bewertung schreiben</a>
																<?php endif; ?>
                                                        </div>
                                                        <h3><?php echo e($value['service_name']); ?></h3>
                                                        <h4><?php echo e(@$value['variantData']['description']); ?></h4>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/Front/User/index.blade.php ENDPATH**/ ?>