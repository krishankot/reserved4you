            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<?php elseif($row->type == 'rating'): ?> 
					...
					<div class="notification-item">
						...
						<p><?php echo e($row->description); ?></p>
						<div class="noti-btn-wrap">
							<a href="<?php echo e(URL::to('cosmetic/'.$getStore->slug.'/?t=reviews#'.base64_encode('r'.$row->appointment_id))); ?>" class="btn btn-details2">Zeige Details</a>
						</div>
					</div>
...
<?php $__env->startSection('front_js'); ?>
    <script>
		 ...
		 $('#allow_notifications').change(function() {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo e(route("allowNotification")); ?>',
				data: {
		...
		function redirectReschedule(id){
			...
			window.location.href = "<?php echo e(url('user-profile')); ?>";
		}
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/Front/User/notification.blade.php ENDPATH**/ ?>