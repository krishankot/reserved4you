        ...
        <div class="d-margin notification-section">
            ...
            <?php if($row->type == 'appointment'): ?>
				...
				<div class="notification-item">
					...
					<div class="noti-btn-wrap">
					   <a href="javascript:void(0);" onclick="getAppointmentDetails(<?php echo $appointmentDetail->id; ?>);" class="btn <?php echo e((strpos($row->title, 'Termin') === false)?((strpos(strtolower($row->title), 'verschoben') !== false)?'btn-warning':'btn-info'):'btn-details'); ?>">Get Details</a>
					</div>
				</div>
            ...
            <?php elseif($row->type == 'rating'): ?>
				<div class="notification-item">
					...
					<p><?php echo e($row->description); ?></p>
					<div class="noti-btn-wrap">
						<a href="<?php echo e(URL::to('dienstleister/betriebsprofil?t=reviews')); ?>" class="btn btn-details2">Get Details</a>
					</div>
				</div>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\projects\laravel\reserved4you_dev\resources\views/ServiceProvider/notification.blade.php ENDPATH**/ ?>