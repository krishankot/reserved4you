                                    ...
                                    <div id="collapse<?php echo e($value->id); ?>" class="collapse" aria-labelledby="heading<?php echo e($value->id); ?>"
                                        ...
                                        <div class="timeline-body ">
                                            ...
                                            <span>
												...
												<a class="text-link btn-sm ml-auto" href="<?php echo e(url('service-provider/appointment#'.$value->id)); ?>">Termin anzeigen</a>
...
<?php echo $__env->make('layouts.serviceProvider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ServiceProvider/dashboard.blade.php ENDPATH**/ ?>